...
export const metadata: Metadata = {
    title: "Commercial Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Auburn. We are the top-rated cleaning company for Commercial Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial cleaners Auburn",
                                "Business cleaning Auburn",
                                "Commercial cleaning company Auburn",
                                "Industrial cleaning Auburn",
                                "Retail cleaning Auburn",
                                "Showroom cleaning Auburn",
                                "Commercial property cleaning Auburn",
                                "Professional commercial cleaners Auburn",
                                "Commercial janitorial services Auburn",
                                "Local commercial cleaners Auburn",
                                "Event cleaning Auburn",
                                "Pub and club cleaning Auburn",
                                "Restaurant cleaning Auburn",
                                "Shopping centre cleaning Auburn",
                                "Commercial sanitisation Auburn",
                                "Office and commercial cleaning Auburn",
                                "Warehouse commercial cleaning Auburn",
                                "Best commercial cleaning Auburn",
                                "Auburn commercial cleaning services"
                            ].map((keyword, index) => (
