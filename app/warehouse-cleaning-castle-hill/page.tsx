...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Castle Hill | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Castle Hill. We are the top-rated cleaning company for Warehouse Cleaning in Castle Hill and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Castle Hill",
                                "Industrial cleaning Castle Hill",
                                "Factory cleaning Castle Hill",
                                "Warehouse cleaners Castle Hill",
                                "Distribution centre cleaning Castle Hill",
                                "Warehouse floor cleaning Castle Hill",
                                "Industrial sweep and scrub Castle Hill",
                                "High pressure cleaning Castle Hill",
                                "Workshop cleaning Castle Hill",
                                "Manufacturing plant cleaning Castle Hill",
                                "Warehouse dusting Castle Hill",
                                "Bond warehouse cleaning Castle Hill",
                                "End of lease warehouse cleaning Castle Hill",
                                "Commercial warehouse cleaning Castle Hill",
                                "Heavy duty cleaning Castle Hill",
                                "Industrial degreasing Castle Hill",
                                "Warehouse sanitisation Castle Hill",
                                "Professional warehouse cleaners Castle Hill",
                                "Storage facility cleaning Castle Hill",
                                "Castle Hill industrial cleaners"
                            ].map((keyword, index) => (
