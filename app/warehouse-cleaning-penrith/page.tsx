...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Penrith. We are the top-rated cleaning company for Warehouse Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Penrith",
                                "Industrial cleaning Penrith",
                                "Factory cleaning Penrith",
                                "Warehouse cleaners Penrith",
                                "Distribution centre cleaning Penrith",
                                "Warehouse floor cleaning Penrith",
                                "Industrial sweep and scrub Penrith",
                                "High pressure cleaning Penrith",
                                "Workshop cleaning Penrith",
                                "Manufacturing plant cleaning Penrith",
                                "Warehouse dusting Penrith",
                                "Bond warehouse cleaning Penrith",
                                "End of lease warehouse cleaning Penrith",
                                "Commercial warehouse cleaning Penrith",
                                "Heavy duty cleaning Penrith",
                                "Industrial degreasing Penrith",
                                "Warehouse sanitisation Penrith",
                                "Professional warehouse cleaners Penrith",
                                "Storage facility cleaning Penrith",
                                "Penrith industrial cleaners"
                            ].map((keyword, index) => (
