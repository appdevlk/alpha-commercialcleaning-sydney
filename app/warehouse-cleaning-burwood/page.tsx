...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Burwood. We are the top-rated cleaning company for Warehouse Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Burwood",
                                "Industrial cleaning Burwood",
                                "Factory cleaning Burwood",
                                "Warehouse cleaners Burwood",
                                "Distribution centre cleaning Burwood",
                                "Warehouse floor cleaning Burwood",
                                "Industrial sweep and scrub Burwood",
                                "High pressure cleaning Burwood",
                                "Workshop cleaning Burwood",
                                "Manufacturing plant cleaning Burwood",
                                "Warehouse dusting Burwood",
                                "Bond warehouse cleaning Burwood",
                                "End of lease warehouse cleaning Burwood",
                                "Commercial warehouse cleaning Burwood",
                                "Heavy duty cleaning Burwood",
                                "Industrial degreasing Burwood",
                                "Warehouse sanitisation Burwood",
                                "Professional warehouse cleaners Burwood",
                                "Storage facility cleaning Burwood",
                                "Burwood industrial cleaners"
                            ].map((keyword, index) => (
