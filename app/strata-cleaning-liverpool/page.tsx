...
export const metadata: Metadata = {
    title: "Strata Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Liverpool. We are the top-rated cleaning company for Strata Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Liverpool",
                                "Strata cleaners Liverpool",
                                "Body corporate cleaning Liverpool",
                                "Building management cleaning Liverpool",
                                "Apartment complex cleaning Liverpool",
                                "Residential building cleaning Liverpool",
                                "Common area cleaning Liverpool",
                                "Strata maintenance Liverpool",
                                "Condominium cleaning Liverpool",
                                "High rise cleaning Liverpool",
                                "Stairwell cleaning Liverpool",
                                "Car park cleaning Liverpool",
                                "Garbage management Liverpool",
                                "Strata gardening and cleaning Liverpool",
                                "Professional strata cleaners Liverpool",
                                "Reliable strata cleaning Liverpool",
                                "Strata cleaning rates Liverpool",
                                "Sydney strata cleaning Liverpool",
                                "Liverpool strata services",
                                "Residential strata cleaning Liverpool"
                            ].map((keyword, index) => (
