...
export const metadata: Metadata = {
    title: "Gym Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Mascot. We are the top-rated cleaning company for Gym Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Mascot",
                                "Fitness centre cleaning Mascot",
                                "Gym cleaners Mascot",
                                "Yoga studio cleaning Mascot",
                                "CrossFit gym cleaning Mascot",
                                "Sports centre cleaning Mascot",
                                "Gym equipment cleaning Mascot",
                                "Health club cleaning Mascot",
                                "Commercial gym cleaning Mascot",
                                "Professional gym cleaners Mascot",
                                "Gym sanitisation Mascot",
                                "Fitness facility cleaning Mascot",
                                "24/7 gym cleaning Mascot",
                                "Local gym cleaners Mascot",
                                "Best gym cleaning company Mascot",
                                "Martial arts studio cleaning Mascot",
                                "Pilates studio cleaning Mascot",
                                "Gym floor cleaning Mascot",
                                "Gym hygiene services Mascot",
                                "Mascot fitness cleaners"
                            ].map((keyword, index) => (
