...
export const metadata: Metadata = {
    title: "Strata Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Burwood. We are the top-rated cleaning company for Strata Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Burwood",
                                "Strata cleaners Burwood",
                                "Body corporate cleaning Burwood",
                                "Building management cleaning Burwood",
                                "Apartment complex cleaning Burwood",
                                "Residential building cleaning Burwood",
                                "Common area cleaning Burwood",
                                "Strata maintenance Burwood",
                                "Condominium cleaning Burwood",
                                "High rise cleaning Burwood",
                                "Stairwell cleaning Burwood",
                                "Car park cleaning Burwood",
                                "Garbage management Burwood",
                                "Strata gardening and cleaning Burwood",
                                "Professional strata cleaners Burwood",
                                "Reliable strata cleaning Burwood",
                                "Strata cleaning rates Burwood",
                                "Sydney strata cleaning Burwood",
                                "Burwood strata services",
                                "Residential strata cleaning Burwood"
                            ].map((keyword, index) => (
