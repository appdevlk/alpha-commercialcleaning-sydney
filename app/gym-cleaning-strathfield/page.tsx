...
export const metadata: Metadata = {
    title: "Gym Cleaning Strathfield | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Strathfield. We are the top-rated cleaning company for Gym Cleaning in Strathfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Strathfield",
                                "Fitness centre cleaning Strathfield",
                                "Gym cleaners Strathfield",
                                "Yoga studio cleaning Strathfield",
                                "CrossFit gym cleaning Strathfield",
                                "Sports centre cleaning Strathfield",
                                "Gym equipment cleaning Strathfield",
                                "Health club cleaning Strathfield",
                                "Commercial gym cleaning Strathfield",
                                "Professional gym cleaners Strathfield",
                                "Gym sanitisation Strathfield",
                                "Fitness facility cleaning Strathfield",
                                "24/7 gym cleaning Strathfield",
                                "Local gym cleaners Strathfield",
                                "Best gym cleaning company Strathfield",
                                "Martial arts studio cleaning Strathfield",
                                "Pilates studio cleaning Strathfield",
                                "Gym floor cleaning Strathfield",
                                "Gym hygiene services Strathfield",
                                "Strathfield fitness cleaners"
                            ].map((keyword, index) => (
