...
export const metadata: Metadata = {
    title: "Office Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Office Cleaning in Mascot. We are the top-rated cleaning company for Office Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Mascot",
                                "Commercial office cleaning Mascot",
                                "Corporate cleaning Mascot",
                                "Office cleaners Mascot",
                                "Business cleaning services Mascot",
                                "Professional office cleaners Mascot",
                                "Daily office cleaning Mascot",
                                "Office janitorial services Mascot",
                                "Small office cleaning Mascot",
                                "Large office cleaning Mascot",
                                "Executive office cleaning Mascot",
                                "Office sanitisation Mascot",
                                "Workspace cleaning Mascot",
                                "Desk cleaning services Mascot",
                                "Reliable office cleaners Mascot",
                                "Affordable office cleaning Mascot",
                                "Office building cleaning Mascot",
                                "Tech park cleaning Mascot",
                                "Strata office cleaning Mascot",
                                "Mascot office cleaning company"
                            ].map((keyword, index) => (
