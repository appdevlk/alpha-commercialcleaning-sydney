...
export const metadata: Metadata = {
    title: "Office Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Office Cleaning in Ryde. We are the top-rated cleaning company for Office Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Ryde",
                                "Commercial office cleaning Ryde",
                                "Corporate cleaning Ryde",
                                "Office cleaners Ryde",
                                "Business cleaning services Ryde",
                                "Professional office cleaners Ryde",
                                "Daily office cleaning Ryde",
                                "Office janitorial services Ryde",
                                "Small office cleaning Ryde",
                                "Large office cleaning Ryde",
                                "Executive office cleaning Ryde",
                                "Office sanitisation Ryde",
                                "Workspace cleaning Ryde",
                                "Desk cleaning services Ryde",
                                "Reliable office cleaners Ryde",
                                "Affordable office cleaning Ryde",
                                "Office building cleaning Ryde",
                                "Tech park cleaning Ryde",
                                "Strata office cleaning Ryde",
                                "Ryde office cleaning company"
                            ].map((keyword, index) => (
