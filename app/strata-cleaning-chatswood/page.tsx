...
export const metadata: Metadata = {
    title: "Strata Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Chatswood. We are the top-rated cleaning company for Strata Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Chatswood",
                                "Strata cleaners Chatswood",
                                "Body corporate cleaning Chatswood",
                                "Building management cleaning Chatswood",
                                "Apartment complex cleaning Chatswood",
                                "Residential building cleaning Chatswood",
                                "Common area cleaning Chatswood",
                                "Strata maintenance Chatswood",
                                "Condominium cleaning Chatswood",
                                "High rise cleaning Chatswood",
                                "Stairwell cleaning Chatswood",
                                "Car park cleaning Chatswood",
                                "Garbage management Chatswood",
                                "Strata gardening and cleaning Chatswood",
                                "Professional strata cleaners Chatswood",
                                "Reliable strata cleaning Chatswood",
                                "Strata cleaning rates Chatswood",
                                "Sydney strata cleaning Chatswood",
                                "Chatswood strata services",
                                "Residential strata cleaning Chatswood"
                            ].map((keyword, index) => (
