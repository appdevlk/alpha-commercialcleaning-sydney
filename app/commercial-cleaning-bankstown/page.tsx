...
export const metadata: Metadata = {
    title: "Commercial Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Bankstown. We are the top-rated cleaning company for Commercial Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Bankstown",
                                "Commercial cleaners Bankstown",
                                "Business cleaning Bankstown",
                                "Commercial cleaning company Bankstown",
                                "Industrial cleaning Bankstown",
                                "Retail cleaning Bankstown",
                                "Showroom cleaning Bankstown",
                                "Commercial property cleaning Bankstown",
                                "Professional commercial cleaners Bankstown",
                                "Commercial janitorial services Bankstown",
                                "Local commercial cleaners Bankstown",
                                "Event cleaning Bankstown",
                                "Pub and club cleaning Bankstown",
                                "Restaurant cleaning Bankstown",
                                "Shopping centre cleaning Bankstown",
                                "Commercial sanitisation Bankstown",
                                "Office and commercial cleaning Bankstown",
                                "Warehouse commercial cleaning Bankstown",
                                "Best commercial cleaning Bankstown",
                                "Bankstown commercial cleaning services"
                            ].map((keyword, index) => (
