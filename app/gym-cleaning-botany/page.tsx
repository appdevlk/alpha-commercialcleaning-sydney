...
export const metadata: Metadata = {
    title: "Gym Cleaning Botany | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Botany. We are the top-rated cleaning company for Gym Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Botany",
                                "Fitness centre cleaning Botany",
                                "Gym cleaners Botany",
                                "Yoga studio cleaning Botany",
                                "CrossFit gym cleaning Botany",
                                "Sports centre cleaning Botany",
                                "Gym equipment cleaning Botany",
                                "Health club cleaning Botany",
                                "Commercial gym cleaning Botany",
                                "Professional gym cleaners Botany",
                                "Gym sanitisation Botany",
                                "Fitness facility cleaning Botany",
                                "24/7 gym cleaning Botany",
                                "Local gym cleaners Botany",
                                "Best gym cleaning company Botany",
                                "Martial arts studio cleaning Botany",
                                "Pilates studio cleaning Botany",
                                "Gym floor cleaning Botany",
                                "Gym hygiene services Botany",
                                "Botany fitness cleaners"
                            ].map((keyword, index) => (
