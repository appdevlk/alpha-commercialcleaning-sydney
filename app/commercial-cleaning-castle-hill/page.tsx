...
export const metadata: Metadata = {
    title: "Commercial Cleaning Castle Hill | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Castle Hill. We are the top-rated cleaning company for Commercial Cleaning in Castle Hill and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial cleaners Castle Hill",
                                "Business cleaning Castle Hill",
                                "Commercial cleaning company Castle Hill",
                                "Industrial cleaning Castle Hill",
                                "Retail cleaning Castle Hill",
                                "Showroom cleaning Castle Hill",
                                "Commercial property cleaning Castle Hill",
                                "Professional commercial cleaners Castle Hill",
                                "Commercial janitorial services Castle Hill",
                                "Local commercial cleaners Castle Hill",
                                "Event cleaning Castle Hill",
                                "Pub and club cleaning Castle Hill",
                                "Restaurant cleaning Castle Hill",
                                "Shopping centre cleaning Castle Hill",
                                "Commercial sanitisation Castle Hill",
                                "Office and commercial cleaning Castle Hill",
                                "Warehouse commercial cleaning Castle Hill",
                                "Best commercial cleaning Castle Hill",
                                "Castle Hill commercial cleaning services"
                            ].map((keyword, index) => (
