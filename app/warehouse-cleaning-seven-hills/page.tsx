...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Seven Hills | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Seven Hills. We are the top-rated cleaning company for Warehouse Cleaning in Seven Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Seven Hills",
                                "Industrial cleaning Seven Hills",
                                "Factory cleaning Seven Hills",
                                "Warehouse cleaners Seven Hills",
                                "Distribution centre cleaning Seven Hills",
                                "Warehouse floor cleaning Seven Hills",
                                "Industrial sweep and scrub Seven Hills",
                                "High pressure cleaning Seven Hills",
                                "Workshop cleaning Seven Hills",
                                "Manufacturing plant cleaning Seven Hills",
                                "Warehouse dusting Seven Hills",
                                "Bond warehouse cleaning Seven Hills",
                                "End of lease warehouse cleaning Seven Hills",
                                "Commercial warehouse cleaning Seven Hills",
                                "Heavy duty cleaning Seven Hills",
                                "Industrial degreasing Seven Hills",
                                "Warehouse sanitisation Seven Hills",
                                "Professional warehouse cleaners Seven Hills",
                                "Storage facility cleaning Seven Hills",
                                "Seven Hills industrial cleaners"
                            ].map((keyword, index) => (
