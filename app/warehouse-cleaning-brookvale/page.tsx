...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Brookvale. We are the top-rated cleaning company for Warehouse Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Brookvale",
                                "Industrial cleaning Brookvale",
                                "Factory cleaning Brookvale",
                                "Warehouse cleaners Brookvale",
                                "Distribution centre cleaning Brookvale",
                                "Warehouse floor cleaning Brookvale",
                                "Industrial sweep and scrub Brookvale",
                                "High pressure cleaning Brookvale",
                                "Workshop cleaning Brookvale",
                                "Manufacturing plant cleaning Brookvale",
                                "Warehouse dusting Brookvale",
                                "Bond warehouse cleaning Brookvale",
                                "End of lease warehouse cleaning Brookvale",
                                "Commercial warehouse cleaning Brookvale",
                                "Heavy duty cleaning Brookvale",
                                "Industrial degreasing Brookvale",
                                "Warehouse sanitisation Brookvale",
                                "Professional warehouse cleaners Brookvale",
                                "Storage facility cleaning Brookvale",
                                "Brookvale industrial cleaners"
                            ].map((keyword, index) => (
