...
export const metadata: Metadata = {
    title: "Commercial Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Mascot. We are the top-rated cleaning company for Commercial Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Mascot",
                                "Commercial cleaners Mascot",
                                "Business cleaning Mascot",
                                "Commercial cleaning company Mascot",
                                "Industrial cleaning Mascot",
                                "Retail cleaning Mascot",
                                "Showroom cleaning Mascot",
                                "Commercial property cleaning Mascot",
                                "Professional commercial cleaners Mascot",
                                "Commercial janitorial services Mascot",
                                "Local commercial cleaners Mascot",
                                "Event cleaning Mascot",
                                "Pub and club cleaning Mascot",
                                "Restaurant cleaning Mascot",
                                "Shopping centre cleaning Mascot",
                                "Commercial sanitisation Mascot",
                                "Office and commercial cleaning Mascot",
                                "Warehouse commercial cleaning Mascot",
                                "Best commercial cleaning Mascot",
                                "Mascot commercial cleaning services"
                            ].map((keyword, index) => (
