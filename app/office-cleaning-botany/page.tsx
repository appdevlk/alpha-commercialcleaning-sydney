...
export const metadata: Metadata = {
    title: "Office Cleaning Botany | Professional Cleaning Services",
    description: "Expert Office Cleaning in Botany. We are the top-rated cleaning company for Office Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Botany",
                                "Commercial office cleaning Botany",
                                "Corporate cleaning Botany",
                                "Office cleaners Botany",
                                "Business cleaning services Botany",
                                "Professional office cleaners Botany",
                                "Daily office cleaning Botany",
                                "Office janitorial services Botany",
                                "Small office cleaning Botany",
                                "Large office cleaning Botany",
                                "Executive office cleaning Botany",
                                "Office sanitisation Botany",
                                "Workspace cleaning Botany",
                                "Desk cleaning services Botany",
                                "Reliable office cleaners Botany",
                                "Affordable office cleaning Botany",
                                "Office building cleaning Botany",
                                "Tech park cleaning Botany",
                                "Strata office cleaning Botany",
                                "Botany office cleaning company"
                            ].map((keyword, index) => (
