...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Randwick. We are the top-rated cleaning company for Warehouse Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Randwick",
                                "Industrial cleaning Randwick",
                                "Factory cleaning Randwick",
                                "Warehouse cleaners Randwick",
                                "Distribution centre cleaning Randwick",
                                "Warehouse floor cleaning Randwick",
                                "Industrial sweep and scrub Randwick",
                                "High pressure cleaning Randwick",
                                "Workshop cleaning Randwick",
                                "Manufacturing plant cleaning Randwick",
                                "Warehouse dusting Randwick",
                                "Bond warehouse cleaning Randwick",
                                "End of lease warehouse cleaning Randwick",
                                "Commercial warehouse cleaning Randwick",
                                "Heavy duty cleaning Randwick",
                                "Industrial degreasing Randwick",
                                "Warehouse sanitisation Randwick",
                                "Professional warehouse cleaners Randwick",
                                "Storage facility cleaning Randwick",
