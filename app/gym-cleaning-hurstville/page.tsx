...
export const metadata: Metadata = {
    title: "Gym Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Hurstville. We are the top-rated cleaning company for Gym Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Hurstville",
                                "Fitness centre cleaning Hurstville",
                                "Gym cleaners Hurstville",
                                "Yoga studio cleaning Hurstville",
                                "CrossFit gym cleaning Hurstville",
                                "Sports centre cleaning Hurstville",
                                "Gym equipment cleaning Hurstville",
                                "Health club cleaning Hurstville",
                                "Commercial gym cleaning Hurstville",
                                "Professional gym cleaners Hurstville",
                                "Gym sanitisation Hurstville",
                                "Fitness facility cleaning Hurstville",
                                "24/7 gym cleaning Hurstville",
                                "Local gym cleaners Hurstville",
                                "Best gym cleaning company Hurstville",
                                "Martial arts studio cleaning Hurstville",
                                "Pilates studio cleaning Hurstville",
                                "Gym floor cleaning Hurstville",
                                "Gym hygiene services Hurstville",
                                "Hurstville fitness cleaners"
                            ].map((keyword, index) => (
