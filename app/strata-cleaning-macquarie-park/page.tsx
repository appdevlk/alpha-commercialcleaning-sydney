...
export const metadata: Metadata = {
    title: "Strata Cleaning Macquarie Park | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Macquarie Park. We are the top-rated cleaning company for Strata Cleaning in Macquarie Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Macquarie Park",
                                "Strata cleaners Macquarie Park",
                                "Body corporate cleaning Macquarie Park",
                                "Building management cleaning Macquarie Park",
                                "Apartment complex cleaning Macquarie Park",
                                "Residential building cleaning Macquarie Park",
                                "Common area cleaning Macquarie Park",
                                "Strata maintenance Macquarie Park",
                                "Condominium cleaning Macquarie Park",
                                "High rise cleaning Macquarie Park",
                                "Stairwell cleaning Macquarie Park",
                                "Car park cleaning Macquarie Park",
                                "Garbage management Macquarie Park",
                                "Strata gardening and cleaning Macquarie Park",
                                "Professional strata cleaners Macquarie Park",
                                "Reliable strata cleaning Macquarie Park",
                                "Strata cleaning rates Macquarie Park",
                                "Sydney strata cleaning Macquarie Park",
                                "Macquarie Park strata services",
                                "Residential strata cleaning Macquarie Park"
                            ].map((keyword, index) => (
