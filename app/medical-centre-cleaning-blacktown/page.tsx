...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Blacktown | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Blacktown. We are the top-rated cleaning company for Medical Centre Cleaning in Blacktown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Blacktown",
                                "Healthcare cleaning services Blacktown",
                                "Medical office cleaning Blacktown",
                                "Dental clinic cleaning Blacktown",
                                "Hospital grade cleaning Blacktown",
                                "Clinical cleaning services Blacktown",
                                "Medical facility cleaning Blacktown",
                                "Doctor surgery cleaning Blacktown",
                                "Professional medical cleaners Blacktown",
                                "Sanitisation services Blacktown",
                                "Medical cleaning company Blacktown",
                                "Allied health cleaning Blacktown",
                                "Pathology cleaning Blacktown",
                                "Radiology cleaning services Blacktown",
                                "Aged care cleaning Blacktown",
                                "Infection control cleaning Blacktown",
                                "Medical centre janitors Blacktown",
                                "Commercial medical cleaning Blacktown",
                                "Blacktown medical cleaners",
                                "Sterile cleaning services Blacktown"
                            ].map((keyword, index) => (
