...
export const metadata: Metadata = {
    title: "Commercial Cleaning Smithfield | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Smithfield. We are the top-rated cleaning company for Commercial Cleaning in Smithfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial cleaners Smithfield",
                                "Business cleaning Smithfield",
                                "Commercial cleaning company Smithfield",
                                "Industrial cleaning Smithfield",
                                "Retail cleaning Smithfield",
                                "Showroom cleaning Smithfield",
                                "Commercial property cleaning Smithfield",
                                "Professional commercial cleaners Smithfield",
                                "Commercial janitorial services Smithfield",
                                "Local commercial cleaners Smithfield",
                                "Event cleaning Smithfield",
                                "Pub and club cleaning Smithfield",
                                "Restaurant cleaning Smithfield",
                                "Shopping centre cleaning Smithfield",
                                "Commercial sanitisation Smithfield",
                                "Office and commercial cleaning Smithfield",
                                "Warehouse commercial cleaning Smithfield",
                                "Best commercial cleaning Smithfield",
                                "Smithfield commercial cleaning services"
                            ].map((keyword, index) => (
