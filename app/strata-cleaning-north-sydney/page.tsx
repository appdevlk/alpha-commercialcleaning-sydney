...
export const metadata: Metadata = {
    title: "Strata Cleaning North Sydney | Professional Cleaning Services",
    description: "Expert Strata Cleaning in North Sydney. We are the top-rated cleaning company for Strata Cleaning in North Sydney and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services North Sydney",
                                "Strata cleaners North Sydney",
                                "Body corporate cleaning North Sydney",
                                "Building management cleaning North Sydney",
                                "Apartment complex cleaning North Sydney",
                                "Residential building cleaning North Sydney",
                                "Common area cleaning North Sydney",
                                "Strata maintenance North Sydney",
                                "Condominium cleaning North Sydney",
                                "High rise cleaning North Sydney",
                                "Stairwell cleaning North Sydney",
                                "Car park cleaning North Sydney",
                                "Garbage management North Sydney",
                                "Strata gardening and cleaning North Sydney",
                                "Professional strata cleaners North Sydney",
                                "Reliable strata cleaning North Sydney",
                                "Strata cleaning rates North Sydney",
                                "Sydney strata cleaning North Sydney",
                                "North Sydney strata services",
                                "Residential strata cleaning North Sydney"
                            ].map((keyword, index) => (
