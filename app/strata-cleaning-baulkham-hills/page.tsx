...
export const metadata: Metadata = {
    title: "Strata Cleaning Baulkham Hills | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Baulkham Hills. We are the top-rated cleaning company for Strata Cleaning in Baulkham Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Baulkham Hills",
                                "Strata cleaners Baulkham Hills",
                                "Body corporate cleaning Baulkham Hills",
                                "Building management cleaning Baulkham Hills",
                                "Apartment complex cleaning Baulkham Hills",
                                "Residential building cleaning Baulkham Hills",
                                "Common area cleaning Baulkham Hills",
                                "Strata maintenance Baulkham Hills",
                                "Condominium cleaning Baulkham Hills",
                                "High rise cleaning Baulkham Hills",
                                "Stairwell cleaning Baulkham Hills",
                                "Car park cleaning Baulkham Hills",
                                "Garbage management Baulkham Hills",
                                "Strata gardening and cleaning Baulkham Hills",
                                "Professional strata cleaners Baulkham Hills",
                                "Reliable strata cleaning Baulkham Hills",
                                "Strata cleaning rates Baulkham Hills",
                                "Sydney strata cleaning Baulkham Hills",
                                "Baulkham Hills strata services",
                                "Residential strata cleaning Baulkham Hills"
                            ].map((keyword, index) => (
