...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Baulkham Hills | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Baulkham Hills. We are the top-rated cleaning company for Medical Centre Cleaning in Baulkham Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Baulkham Hills",
                                "Healthcare cleaning services Baulkham Hills",
                                "Medical office cleaning Baulkham Hills",
                                "Dental clinic cleaning Baulkham Hills",
                                "Hospital grade cleaning Baulkham Hills",
                                "Clinical cleaning services Baulkham Hills",
                                "Medical facility cleaning Baulkham Hills",
                                "Doctor surgery cleaning Baulkham Hills",
                                "Professional medical cleaners Baulkham Hills",
                                "Sanitisation services Baulkham Hills",
                                "Medical cleaning company Baulkham Hills",
                                "Allied health cleaning Baulkham Hills",
                                "Pathology cleaning Baulkham Hills",
                                "Radiology cleaning services Baulkham Hills",
                                "Aged care cleaning Baulkham Hills",
                                "Infection control cleaning Baulkham Hills",
                                "Medical centre janitors Baulkham Hills",
                                "Commercial medical cleaning Baulkham Hills",
                                "Baulkham Hills medical cleaners",
                                "Sterile cleaning services Baulkham Hills"
                            ].map((keyword, index) => (
