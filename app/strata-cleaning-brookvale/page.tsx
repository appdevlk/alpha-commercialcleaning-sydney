...
export const metadata: Metadata = {
    title: "Strata Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Brookvale. We are the top-rated cleaning company for Strata Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Brookvale",
                                "Strata cleaners Brookvale",
                                "Body corporate cleaning Brookvale",
                                "Building management cleaning Brookvale",
                                "Apartment complex cleaning Brookvale",
                                "Residential building cleaning Brookvale",
                                "Common area cleaning Brookvale",
                                "Strata maintenance Brookvale",
                                "Condominium cleaning Brookvale",
                                "High rise cleaning Brookvale",
                                "Stairwell cleaning Brookvale",
                                "Car park cleaning Brookvale",
                                "Garbage management Brookvale",
                                "Strata gardening and cleaning Brookvale",
                                "Professional strata cleaners Brookvale",
                                "Reliable strata cleaning Brookvale",
                                "Strata cleaning rates Brookvale",
                                "Sydney strata cleaning Brookvale",
                                "Brookvale strata services",
                                "Residential strata cleaning Brookvale"
                            ].map((keyword, index) => (
