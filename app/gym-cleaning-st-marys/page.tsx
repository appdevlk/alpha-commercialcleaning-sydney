...
export const metadata: Metadata = {
    title: "Gym Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Gym Cleaning in St Marys. We are the top-rated cleaning company for Gym Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services St Marys",
                                "Fitness centre cleaning St Marys",
                                "Gym cleaners St Marys",
                                "Yoga studio cleaning St Marys",
                                "CrossFit gym cleaning St Marys",
                                "Sports centre cleaning St Marys",
                                "Gym equipment cleaning St Marys",
                                "Health club cleaning St Marys",
                                "Commercial gym cleaning St Marys",
                                "Professional gym cleaners St Marys",
                                "Gym sanitisation St Marys",
                                "Fitness facility cleaning St Marys",
                                "24/7 gym cleaning St Marys",
                                "Local gym cleaners St Marys",
                                "Best gym cleaning company St Marys",
                                "Martial arts studio cleaning St Marys",
                                "Pilates studio cleaning St Marys",
                                "Gym floor cleaning St Marys",
                                "Gym hygiene services St Marys",
                                "St Marys fitness cleaners"
                            ].map((keyword, index) => (
