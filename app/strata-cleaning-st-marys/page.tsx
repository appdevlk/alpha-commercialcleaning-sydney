...
export const metadata: Metadata = {
    title: "Strata Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Strata Cleaning in St Marys. We are the top-rated cleaning company for Strata Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services St Marys",
                                "Strata cleaners St Marys",
                                "Body corporate cleaning St Marys",
                                "Building management cleaning St Marys",
                                "Apartment complex cleaning St Marys",
                                "Residential building cleaning St Marys",
                                "Common area cleaning St Marys",
                                "Strata maintenance St Marys",
                                "Condominium cleaning St Marys",
                                "High rise cleaning St Marys",
                                "Stairwell cleaning St Marys",
                                "Car park cleaning St Marys",
                                "Garbage management St Marys",
                                "Strata gardening and cleaning St Marys",
                                "Professional strata cleaners St Marys",
                                "Reliable strata cleaning St Marys",
                                "Strata cleaning rates St Marys",
                                "Sydney strata cleaning St Marys",
                                "St Marys strata services",
                                "Residential strata cleaning St Marys"
                            ].map((keyword, index) => (
