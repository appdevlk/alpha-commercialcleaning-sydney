...
export const metadata: Metadata = {
    title: "Commercial Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Liverpool. We are the top-rated cleaning company for Commercial Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Liverpool",
                                "Commercial cleaners Liverpool",
                                "Business cleaning Liverpool",
                                "Commercial cleaning company Liverpool",
                                "Industrial cleaning Liverpool",
                                "Retail cleaning Liverpool",
                                "Showroom cleaning Liverpool",
                                "Commercial property cleaning Liverpool",
                                "Professional commercial cleaners Liverpool",
                                "Commercial janitorial services Liverpool",
                                "Local commercial cleaners Liverpool",
                                "Event cleaning Liverpool",
                                "Pub and club cleaning Liverpool",
                                "Restaurant cleaning Liverpool",
                                "Shopping centre cleaning Liverpool",
                                "Commercial sanitisation Liverpool",
                                "Office and commercial cleaning Liverpool",
                                "Warehouse commercial cleaning Liverpool",
                                "Best commercial cleaning Liverpool",
                                "Liverpool commercial cleaning services"
                            ].map((keyword, index) => (
