...
export const metadata: Metadata = {
    title: "Commercial Cleaning Silverwater | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Silverwater. We are the top-rated cleaning company for Commercial Cleaning in Silverwater and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial cleaners Silverwater",
                                "Business cleaning Silverwater",
                                "Commercial cleaning company Silverwater",
                                "Industrial cleaning Silverwater",
                                "Retail cleaning Silverwater",
                                "Showroom cleaning Silverwater",
                                "Commercial property cleaning Silverwater",
                                "Professional commercial cleaners Silverwater",
                                "Commercial janitorial services Silverwater",
                                "Local commercial cleaners Silverwater",
                                "Event cleaning Silverwater",
                                "Pub and club cleaning Silverwater",
                                "Restaurant cleaning Silverwater",
                                "Shopping centre cleaning Silverwater",
                                "Commercial sanitisation Silverwater",
                                "Office and commercial cleaning Silverwater",
                                "Warehouse commercial cleaning Silverwater",
                                "Best commercial cleaning Silverwater",
                                "Silverwater commercial cleaning services"
                            ].map((keyword, index) => (
