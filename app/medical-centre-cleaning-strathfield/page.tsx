...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Strathfield | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Strathfield. We are the top-rated cleaning company for Medical Centre Cleaning in Strathfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Strathfield",
                                "Healthcare cleaning services Strathfield",
                                "Medical office cleaning Strathfield",
                                "Dental clinic cleaning Strathfield",
                                "Hospital grade cleaning Strathfield",
                                "Clinical cleaning services Strathfield",
                                "Medical facility cleaning Strathfield",
                                "Doctor surgery cleaning Strathfield",
                                "Professional medical cleaners Strathfield",
                                "Sanitisation services Strathfield",
                                "Medical cleaning company Strathfield",
                                "Allied health cleaning Strathfield",
                                "Pathology cleaning Strathfield",
                                "Radiology cleaning services Strathfield",
                                "Aged care cleaning Strathfield",
                                "Infection control cleaning Strathfield",
                                "Medical centre janitors Strathfield",
                                "Commercial medical cleaning Strathfield",
                                "Strathfield medical cleaners",
                                "Sterile cleaning services Strathfield"
                            ].map((keyword, index) => (
