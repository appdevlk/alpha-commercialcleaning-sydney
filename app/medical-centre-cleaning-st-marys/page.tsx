...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in St Marys. We are the top-rated cleaning company for Medical Centre Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning St Marys",
                                "Healthcare cleaning services St Marys",
                                "Medical office cleaning St Marys",
                                "Dental clinic cleaning St Marys",
                                "Hospital grade cleaning St Marys",
                                "Clinical cleaning services St Marys",
                                "Medical facility cleaning St Marys",
                                "Doctor surgery cleaning St Marys",
                                "Professional medical cleaners St Marys",
                                "Sanitisation services St Marys",
                                "Medical cleaning company St Marys",
                                "Allied health cleaning St Marys",
                                "Pathology cleaning St Marys",
                                "Radiology cleaning services St Marys",
                                "Aged care cleaning St Marys",
                                "Infection control cleaning St Marys",
                                "Medical centre janitors St Marys",
                                "Commercial medical cleaning St Marys",
                                "St Marys medical cleaners",
                                "Sterile cleaning services St Marys"
                            ].map((keyword, index) => (
