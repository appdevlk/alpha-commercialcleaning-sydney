...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Cronulla. We are the top-rated cleaning company for Warehouse Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Cronulla",
                                "Industrial cleaning Cronulla",
                                "Factory cleaning Cronulla",
                                "Warehouse cleaners Cronulla",
                                "Distribution centre cleaning Cronulla",
                                "Warehouse floor cleaning Cronulla",
                                "Industrial sweep and scrub Cronulla",
                                "High pressure cleaning Cronulla",
                                "Workshop cleaning Cronulla",
                                "Manufacturing plant cleaning Cronulla",
                                "Warehouse dusting Cronulla",
                                "Bond warehouse cleaning Cronulla",
                                "End of lease warehouse cleaning Cronulla",
                                "Commercial warehouse cleaning Cronulla",
                                "Heavy duty cleaning Cronulla",
                                "Industrial degreasing Cronulla",
                                "Warehouse sanitisation Cronulla",
                                "Professional warehouse cleaners Cronulla",
                                "Storage facility cleaning Cronulla",
                                "Cronulla industrial cleaners"
                            ].map((keyword, index) => (
