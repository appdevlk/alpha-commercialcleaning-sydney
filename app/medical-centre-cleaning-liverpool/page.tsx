...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Liverpool. We are the top-rated cleaning company for Medical Centre Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Liverpool",
                                "Healthcare cleaning services Liverpool",
                                "Medical office cleaning Liverpool",
                                "Dental clinic cleaning Liverpool",
                                "Hospital grade cleaning Liverpool",
                                "Clinical cleaning services Liverpool",
                                "Medical facility cleaning Liverpool",
                                "Doctor surgery cleaning Liverpool",
                                "Professional medical cleaners Liverpool",
                                "Sanitisation services Liverpool",
                                "Medical cleaning company Liverpool",
                                "Allied health cleaning Liverpool",
                                "Pathology cleaning Liverpool",
                                "Radiology cleaning services Liverpool",
                                "Aged care cleaning Liverpool",
                                "Infection control cleaning Liverpool",
                                "Medical centre janitors Liverpool",
                                "Commercial medical cleaning Liverpool",
                                "Liverpool medical cleaners",
                                "Sterile cleaning services Liverpool"
                            ].map((keyword, index) => (
