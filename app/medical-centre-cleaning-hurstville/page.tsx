...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Hurstville. We are the top-rated cleaning company for Medical Centre Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Hurstville",
                                "Healthcare cleaning services Hurstville",
                                "Medical office cleaning Hurstville",
                                "Dental clinic cleaning Hurstville",
                                "Hospital grade cleaning Hurstville",
                                "Clinical cleaning services Hurstville",
                                "Medical facility cleaning Hurstville",
                                "Doctor surgery cleaning Hurstville",
                                "Professional medical cleaners Hurstville",
                                "Sanitisation services Hurstville",
                                "Medical cleaning company Hurstville",
                                "Allied health cleaning Hurstville",
                                "Pathology cleaning Hurstville",
                                "Radiology cleaning services Hurstville",
                                "Aged care cleaning Hurstville",
                                "Infection control cleaning Hurstville",
                                "Medical centre janitors Hurstville",
                                "Commercial medical cleaning Hurstville",
                                "Hurstville medical cleaners",
                                "Sterile cleaning services Hurstville"
                            ].map((keyword, index) => (
