...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Penrith. We are the top-rated cleaning company for Medical Centre Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Penrith",
                                "Healthcare cleaning services Penrith",
                                "Medical office cleaning Penrith",
                                "Dental clinic cleaning Penrith",
                                "Hospital grade cleaning Penrith",
                                "Clinical cleaning services Penrith",
                                "Medical facility cleaning Penrith",
                                "Doctor surgery cleaning Penrith",
                                "Professional medical cleaners Penrith",
                                "Sanitisation services Penrith",
                                "Medical cleaning company Penrith",
                                "Allied health cleaning Penrith",
                                "Pathology cleaning Penrith",
                                "Radiology cleaning services Penrith",
                                "Aged care cleaning Penrith",
                                "Infection control cleaning Penrith",
                                "Medical centre janitors Penrith",
                                "Commercial medical cleaning Penrith",
                                "Penrith medical cleaners",
                                "Sterile cleaning services Penrith"
                            ].map((keyword, index) => (
