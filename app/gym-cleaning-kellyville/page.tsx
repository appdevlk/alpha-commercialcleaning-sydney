...
export const metadata: Metadata = {
    title: "Gym Cleaning Kellyville | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Kellyville. We are the top-rated cleaning company for Gym Cleaning in Kellyville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Kellyville",
                                "Fitness centre cleaning Kellyville",
                                "Gym cleaners Kellyville",
                                "Yoga studio cleaning Kellyville",
                                "CrossFit gym cleaning Kellyville",
                                "Sports centre cleaning Kellyville",
                                "Gym equipment cleaning Kellyville",
                                "Health club cleaning Kellyville",
                                "Commercial gym cleaning Kellyville",
                                "Professional gym cleaners Kellyville",
                                "Gym sanitisation Kellyville",
                                "Fitness facility cleaning Kellyville",
                                "24/7 gym cleaning Kellyville",
                                "Local gym cleaners Kellyville",
                                "Best gym cleaning company Kellyville",
                                "Martial arts studio cleaning Kellyville",
                                "Pilates studio cleaning Kellyville",
                                "Gym floor cleaning Kellyville",
                                "Gym hygiene services Kellyville",
                                "Kellyville fitness cleaners"
                            ].map((keyword, index) => (
