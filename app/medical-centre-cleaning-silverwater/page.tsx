...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Silverwater | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Silverwater. We are the top-rated cleaning company for Medical Centre Cleaning in Silverwater and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Silverwater",
                                "Healthcare cleaning services Silverwater",
                                "Medical office cleaning Silverwater",
                                "Dental clinic cleaning Silverwater",
                                "Hospital grade cleaning Silverwater",
                                "Clinical cleaning services Silverwater",
                                "Medical facility cleaning Silverwater",
                                "Doctor surgery cleaning Silverwater",
                                "Professional medical cleaners Silverwater",
                                "Sanitisation services Silverwater",
                                "Medical cleaning company Silverwater",
                                "Allied health cleaning Silverwater",
                                "Pathology cleaning Silverwater",
                                "Radiology cleaning services Silverwater",
                                "Aged care cleaning Silverwater",
                                "Infection control cleaning Silverwater",
                                "Medical centre janitors Silverwater",
                                "Commercial medical cleaning Silverwater",
                                "Silverwater medical cleaners",
                                "Sterile cleaning services Silverwater"
                            ].map((keyword, index) => (
