...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Marrickville | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Marrickville. We are the top-rated cleaning company for Warehouse Cleaning in Marrickville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Marrickville",
                                "Industrial cleaning Marrickville",
                                "Factory cleaning Marrickville",
                                "Warehouse cleaners Marrickville",
                                "Distribution centre cleaning Marrickville",
                                "Warehouse floor cleaning Marrickville",
                                "Industrial sweep and scrub Marrickville",
                                "High pressure cleaning Marrickville",
                                "Workshop cleaning Marrickville",
                                "Manufacturing plant cleaning Marrickville",
                                "Warehouse dusting Marrickville",
                                "Bond warehouse cleaning Marrickville",
                                "End of lease warehouse cleaning Marrickville",
                                "Commercial warehouse cleaning Marrickville",
                                "Heavy duty cleaning Marrickville",
                                "Industrial degreasing Marrickville",
                                "Warehouse sanitisation Marrickville",
                                "Professional warehouse cleaners Marrickville",
                                "Storage facility cleaning Marrickville",
                                "Marrickville industrial cleaners"
                            ].map((keyword, index) => (
