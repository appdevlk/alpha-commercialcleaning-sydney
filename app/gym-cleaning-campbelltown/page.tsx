...
export const metadata: Metadata = {
    title: "Gym Cleaning Campbelltown | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Campbelltown. We are the top-rated cleaning company for Gym Cleaning in Campbelltown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Campbelltown",
                                "Fitness centre cleaning Campbelltown",
                                "Gym cleaners Campbelltown",
                                "Yoga studio cleaning Campbelltown",
                                "CrossFit gym cleaning Campbelltown",
                                "Sports centre cleaning Campbelltown",
                                "Gym equipment cleaning Campbelltown",
                                "Health club cleaning Campbelltown",
                                "Commercial gym cleaning Campbelltown",
                                "Professional gym cleaners Campbelltown",
                                "Gym sanitisation Campbelltown",
                                "Fitness facility cleaning Campbelltown",
                                "24/7 gym cleaning Campbelltown",
                                "Local gym cleaners Campbelltown",
                                "Best gym cleaning company Campbelltown",
                                "Martial arts studio cleaning Campbelltown",
                                "Pilates studio cleaning Campbelltown",
                                "Gym floor cleaning Campbelltown",
                                "Gym hygiene services Campbelltown",
                                "Campbelltown fitness cleaners"
                            ].map((keyword, index) => (
