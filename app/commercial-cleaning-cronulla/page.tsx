...
export const metadata: Metadata = {
    title: "Commercial Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Cronulla. We are the top-rated cleaning company for Commercial Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Cronulla",
                                "Commercial cleaners Cronulla",
                                "Business cleaning Cronulla",
                                "Commercial cleaning company Cronulla",
                                "Industrial cleaning Cronulla",
                                "Retail cleaning Cronulla",
                                "Showroom cleaning Cronulla",
                                "Commercial property cleaning Cronulla",
                                "Professional commercial cleaners Cronulla",
                                "Commercial janitorial services Cronulla",
                                "Local commercial cleaners Cronulla",
                                "Event cleaning Cronulla",
                                "Pub and club cleaning Cronulla",
                                "Restaurant cleaning Cronulla",
                                "Shopping centre cleaning Cronulla",
                                "Commercial sanitisation Cronulla",
                                "Office and commercial cleaning Cronulla",
                                "Warehouse commercial cleaning Cronulla",
                                "Best commercial cleaning Cronulla",
                                "Cronulla commercial cleaning services"
                            ].map((keyword, index) => (
