...
export const metadata: Metadata = {
    title: "Commercial Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Penrith. We are the top-rated cleaning company for Commercial Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Penrith",
                                "Commercial cleaners Penrith",
                                "Business cleaning Penrith",
                                "Commercial cleaning company Penrith",
                                "Industrial cleaning Penrith",
                                "Retail cleaning Penrith",
                                "Showroom cleaning Penrith",
                                "Commercial property cleaning Penrith",
                                "Professional commercial cleaners Penrith",
                                "Commercial janitorial services Penrith",
                                "Local commercial cleaners Penrith",
                                "Event cleaning Penrith",
                                "Pub and club cleaning Penrith",
                                "Restaurant cleaning Penrith",
                                "Shopping centre cleaning Penrith",
                                "Commercial sanitisation Penrith",
                                "Office and commercial cleaning Penrith",
                                "Warehouse commercial cleaning Penrith",
                                "Best commercial cleaning Penrith",
                                "Penrith commercial cleaning services"
                            ].map((keyword, index) => (
