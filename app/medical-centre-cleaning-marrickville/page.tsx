...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Marrickville | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Marrickville. We are the top-rated cleaning company for Medical Centre Cleaning in Marrickville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Marrickville",
                                "Healthcare cleaning services Marrickville",
                                "Medical office cleaning Marrickville",
                                "Dental clinic cleaning Marrickville",
                                "Hospital grade cleaning Marrickville",
                                "Clinical cleaning services Marrickville",
                                "Medical facility cleaning Marrickville",
                                "Doctor surgery cleaning Marrickville",
                                "Professional medical cleaners Marrickville",
                                "Sanitisation services Marrickville",
                                "Medical cleaning company Marrickville",
                                "Allied health cleaning Marrickville",
                                "Pathology cleaning Marrickville",
                                "Radiology cleaning services Marrickville",
                                "Aged care cleaning Marrickville",
                                "Infection control cleaning Marrickville",
                                "Medical centre janitors Marrickville",
                                "Commercial medical cleaning Marrickville",
                                "Marrickville medical cleaners",
                                "Sterile cleaning services Marrickville"
                            ].map((keyword, index) => (
