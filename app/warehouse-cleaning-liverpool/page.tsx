...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Liverpool. We are the top-rated cleaning company for Warehouse Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Liverpool",
                                "Industrial cleaning Liverpool",
                                "Factory cleaning Liverpool",
                                "Warehouse cleaners Liverpool",
                                "Distribution centre cleaning Liverpool",
                                "Warehouse floor cleaning Liverpool",
                                "Industrial sweep and scrub Liverpool",
                                "High pressure cleaning Liverpool",
                                "Workshop cleaning Liverpool",
                                "Manufacturing plant cleaning Liverpool",
                                "Warehouse dusting Liverpool",
                                "Bond warehouse cleaning Liverpool",
                                "End of lease warehouse cleaning Liverpool",
                                "Commercial warehouse cleaning Liverpool",
                                "Heavy duty cleaning Liverpool",
                                "Industrial degreasing Liverpool",
                                "Warehouse sanitisation Liverpool",
                                "Professional warehouse cleaners Liverpool",
                                "Storage facility cleaning Liverpool",
                                "Liverpool industrial cleaners"
                            ].map((keyword, index) => (
