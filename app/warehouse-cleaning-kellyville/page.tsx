...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Kellyville | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Kellyville. We are the top-rated cleaning company for Warehouse Cleaning in Kellyville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Kellyville",
                                "Industrial cleaning Kellyville",
                                "Factory cleaning Kellyville",
                                "Warehouse cleaners Kellyville",
                                "Distribution centre cleaning Kellyville",
                                "Warehouse floor cleaning Kellyville",
                                "Industrial sweep and scrub Kellyville",
                                "High pressure cleaning Kellyville",
                                "Workshop cleaning Kellyville",
                                "Manufacturing plant cleaning Kellyville",
                                "Warehouse dusting Kellyville",
                                "Bond warehouse cleaning Kellyville",
                                "End of lease warehouse cleaning Kellyville",
                                "Commercial warehouse cleaning Kellyville",
                                "Heavy duty cleaning Kellyville",
                                "Industrial degreasing Kellyville",
                                "Warehouse sanitisation Kellyville",
                                "Professional warehouse cleaners Kellyville",
                                "Storage facility cleaning Kellyville",
                                "Kellyville industrial cleaners"
                            ].map((keyword, index) => (
