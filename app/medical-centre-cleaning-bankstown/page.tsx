...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Bankstown. We are the top-rated cleaning company for Medical Centre Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Bankstown",
                                "Healthcare cleaning services Bankstown",
                                "Medical office cleaning Bankstown",
                                "Dental clinic cleaning Bankstown",
                                "Hospital grade cleaning Bankstown",
                                "Clinical cleaning services Bankstown",
                                "Medical facility cleaning Bankstown",
                                "Doctor surgery cleaning Bankstown",
                                "Professional medical cleaners Bankstown",
                                "Sanitisation services Bankstown",
                                "Medical cleaning company Bankstown",
                                "Allied health cleaning Bankstown",
                                "Pathology cleaning Bankstown",
                                "Radiology cleaning services Bankstown",
                                "Aged care cleaning Bankstown",
                                "Infection control cleaning Bankstown",
                                "Medical centre janitors Bankstown",
                                "Commercial medical cleaning Bankstown",
                                "Bankstown medical cleaners",
                                "Sterile cleaning services Bankstown"
                            ].map((keyword, index) => (
