...
export const metadata: Metadata = {
    title: "Strata Cleaning Surry Hills | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Surry Hills. We are the top-rated cleaning company for Strata Cleaning in Surry Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Surry Hills",
                                "Strata cleaners Surry Hills",
                                "Body corporate cleaning Surry Hills",
                                "Building management cleaning Surry Hills",
                                "Apartment complex cleaning Surry Hills",
                                "Residential building cleaning Surry Hills",
                                "Common area cleaning Surry Hills",
                                "Strata maintenance Surry Hills",
                                "Condominium cleaning Surry Hills",
                                "High rise cleaning Surry Hills",
                                "Stairwell cleaning Surry Hills",
                                "Car park cleaning Surry Hills",
                                "Garbage management Surry Hills",
                                "Strata gardening and cleaning Surry Hills",
                                "Professional strata cleaners Surry Hills",
                                "Reliable strata cleaning Surry Hills",
                                "Strata cleaning rates Surry Hills",
                                "Sydney strata cleaning Surry Hills",
                                "Surry Hills strata services",
                                "Residential strata cleaning Surry Hills"
                            ].map((keyword, index) => (
