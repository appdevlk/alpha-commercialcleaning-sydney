...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning North Sydney | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in North Sydney. We are the top-rated cleaning company for Medical Centre Cleaning in North Sydney and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning North Sydney",
                                "Healthcare cleaning services North Sydney",
                                "Medical office cleaning North Sydney",
                                "Dental clinic cleaning North Sydney",
                                "Hospital grade cleaning North Sydney",
                                "Clinical cleaning services North Sydney",
                                "Medical facility cleaning North Sydney",
                                "Doctor surgery cleaning North Sydney",
                                "Professional medical cleaners North Sydney",
                                "Sanitisation services North Sydney",
                                "Medical cleaning company North Sydney",
                                "Allied health cleaning North Sydney",
                                "Pathology cleaning North Sydney",
                                "Radiology cleaning services North Sydney",
                                "Aged care cleaning North Sydney",
                                "Infection control cleaning North Sydney",
                                "Medical centre janitors North Sydney",
                                "Commercial medical cleaning North Sydney",
                                "North Sydney medical cleaners",
                                "Sterile cleaning services North Sydney"
                            ].map((keyword, index) => (
