...
export const metadata: Metadata = {
    title: "Warehouse Cleaning North Sydney | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in North Sydney. We are the top-rated cleaning company for Warehouse Cleaning in North Sydney and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services North Sydney",
                                "Industrial cleaning North Sydney",
                                "Factory cleaning North Sydney",
                                "Warehouse cleaners North Sydney",
                                "Distribution centre cleaning North Sydney",
                                "Warehouse floor cleaning North Sydney",
                                "Industrial sweep and scrub North Sydney",
                                "High pressure cleaning North Sydney",
                                "Workshop cleaning North Sydney",
                                "Manufacturing plant cleaning North Sydney",
                                "Warehouse dusting North Sydney",
                                "Bond warehouse cleaning North Sydney",
                                "End of lease warehouse cleaning North Sydney",
                                "Commercial warehouse cleaning North Sydney",
                                "Heavy duty cleaning North Sydney",
                                "Industrial degreasing North Sydney",
                                "Warehouse sanitisation North Sydney",
                                "Professional warehouse cleaners North Sydney",
                                "Storage facility cleaning North Sydney",
                                "North Sydney industrial cleaners"
                            ].map((keyword, index) => (
