...
export const metadata: Metadata = {
    title: "Strata Cleaning Marrickville | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Marrickville. We are the top-rated cleaning company for Strata Cleaning in Marrickville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Marrickville",
                                "Strata cleaners Marrickville",
                                "Body corporate cleaning Marrickville",
                                "Building management cleaning Marrickville",
                                "Apartment complex cleaning Marrickville",
                                "Residential building cleaning Marrickville",
                                "Common area cleaning Marrickville",
                                "Strata maintenance Marrickville",
                                "Condominium cleaning Marrickville",
                                "High rise cleaning Marrickville",
                                "Stairwell cleaning Marrickville",
                                "Car park cleaning Marrickville",
                                "Garbage management Marrickville",
                                "Strata gardening and cleaning Marrickville",
                                "Professional strata cleaners Marrickville",
                                "Reliable strata cleaning Marrickville",
                                "Strata cleaning rates Marrickville",
                                "Sydney strata cleaning Marrickville",
                                "Marrickville strata services",
                                "Residential strata cleaning Marrickville"
                            ].map((keyword, index) => (
