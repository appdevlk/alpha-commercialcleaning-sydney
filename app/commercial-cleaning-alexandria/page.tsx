...
export const metadata: Metadata = {
    title: "Commercial Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Alexandria. We are the top-rated cleaning company for Commercial Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial cleaners Alexandria",
                                "Business cleaning Alexandria",
                                "Commercial cleaning company Alexandria",
                                "Industrial cleaning Alexandria",
                                "Retail cleaning Alexandria",
                                "Showroom cleaning Alexandria",
                                "Commercial property cleaning Alexandria",
                                "Professional commercial cleaners Alexandria",
                                "Commercial janitorial services Alexandria",
                                "Local commercial cleaners Alexandria",
                                "Event cleaning Alexandria",
                                "Pub and club cleaning Alexandria",
                                "Restaurant cleaning Alexandria",
                                "Shopping centre cleaning Alexandria",
                                "Commercial sanitisation Alexandria",
                                "Office and commercial cleaning Alexandria",
                                "Warehouse commercial cleaning Alexandria",
                                "Best commercial cleaning Alexandria",
                                "Alexandria commercial cleaning services"
                            ].map((keyword, index) => (
