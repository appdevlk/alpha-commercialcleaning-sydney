...
export const metadata: Metadata = {
    title: "Gym Cleaning Marrickville | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Marrickville. We are the top-rated cleaning company for Gym Cleaning in Marrickville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Marrickville",
                                "Fitness centre cleaning Marrickville",
                                "Gym cleaners Marrickville",
                                "Yoga studio cleaning Marrickville",
                                "CrossFit gym cleaning Marrickville",
                                "Sports centre cleaning Marrickville",
                                "Gym equipment cleaning Marrickville",
                                "Health club cleaning Marrickville",
                                "Commercial gym cleaning Marrickville",
                                "Professional gym cleaners Marrickville",
                                "Gym sanitisation Marrickville",
                                "Fitness facility cleaning Marrickville",
                                "24/7 gym cleaning Marrickville",
                                "Local gym cleaners Marrickville",
                                "Best gym cleaning company Marrickville",
                                "Martial arts studio cleaning Marrickville",
                                "Pilates studio cleaning Marrickville",
                                "Gym floor cleaning Marrickville",
                                "Gym hygiene services Marrickville",
                                "Marrickville fitness cleaners"
                            ].map((keyword, index) => (
