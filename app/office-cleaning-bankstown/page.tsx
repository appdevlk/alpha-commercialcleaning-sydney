...
export const metadata: Metadata = {
    title: "Office Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Office Cleaning in Bankstown. We are the top-rated cleaning company for Office Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Bankstown",
                                "Commercial office cleaning Bankstown",
                                "Corporate cleaning Bankstown",
                                "Office cleaners Bankstown",
                                "Business cleaning services Bankstown",
                                "Professional office cleaners Bankstown",
                                "Daily office cleaning Bankstown",
                                "Office janitorial services Bankstown",
                                "Small office cleaning Bankstown",
                                "Large office cleaning Bankstown",
                                "Executive office cleaning Bankstown",
                                "Office sanitisation Bankstown",
                                "Workspace cleaning Bankstown",
                                "Desk cleaning services Bankstown",
                                "Reliable office cleaners Bankstown",
                                "Affordable office cleaning Bankstown",
                                "Office building cleaning Bankstown",
                                "Tech park cleaning Bankstown",
                                "Strata office cleaning Bankstown",
                                "Bankstown office cleaning company"
                            ].map((keyword, index) => (
