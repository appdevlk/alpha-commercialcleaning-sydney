...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Castle Hill | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Castle Hill. We are the top-rated cleaning company for Medical Centre Cleaning in Castle Hill and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Castle Hill",
                                "Medical office cleaning Castle Hill",
                                "Dental clinic cleaning Castle Hill",
                                "Hospital grade cleaning Castle Hill",
                                "Clinical cleaning services Castle Hill",
                                "Medical facility cleaning Castle Hill",
                                "Doctor surgery cleaning Castle Hill",
                                "Professional medical cleaners Castle Hill",
                                "Sanitisation services Castle Hill",
                                "Medical cleaning company Castle Hill",
                                "Allied health cleaning Castle Hill",
                                "Pathology cleaning Castle Hill",
                                "Radiology cleaning services Castle Hill",
                                "Aged care cleaning Castle Hill",
                                "Infection control cleaning Castle Hill",
                                "Medical centre janitors Castle Hill",
                                "Commercial medical cleaning Castle Hill",
                                "Castle Hill medical cleaners",
                                "Sterile cleaning services Castle Hill"
                            ].map((keyword, index) => (
