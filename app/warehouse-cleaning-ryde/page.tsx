...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Ryde. We are the top-rated cleaning company for Warehouse Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Ryde",
                                "Industrial cleaning Ryde",
                                "Factory cleaning Ryde",
                                "Warehouse cleaners Ryde",
                                "Distribution centre cleaning Ryde",
                                "Warehouse floor cleaning Ryde",
                                "Industrial sweep and scrub Ryde",
                                "High pressure cleaning Ryde",
                                "Workshop cleaning Ryde",
                                "Manufacturing plant cleaning Ryde",
                                "Warehouse dusting Ryde",
                                "Bond warehouse cleaning Ryde",
                                "End of lease warehouse cleaning Ryde",
                                "Commercial warehouse cleaning Ryde",
                                "Heavy duty cleaning Ryde",
                                "Industrial degreasing Ryde",
                                "Warehouse sanitisation Ryde",
                                "Professional warehouse cleaners Ryde",
                                "Storage facility cleaning Ryde",
                                "Ryde industrial cleaners"
                            ].map((keyword, index) => (
