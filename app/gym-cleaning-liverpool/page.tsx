...
export const metadata: Metadata = {
    title: "Gym Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Liverpool. We are the top-rated cleaning company for Gym Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Liverpool",
                                "Fitness centre cleaning Liverpool",
                                "Gym cleaners Liverpool",
                                "Yoga studio cleaning Liverpool",
                                "CrossFit gym cleaning Liverpool",
                                "Sports centre cleaning Liverpool",
                                "Gym equipment cleaning Liverpool",
                                "Health club cleaning Liverpool",
                                "Commercial gym cleaning Liverpool",
                                "Professional gym cleaners Liverpool",
                                "Gym sanitisation Liverpool",
                                "Fitness facility cleaning Liverpool",
                                "24/7 gym cleaning Liverpool",
                                "Local gym cleaners Liverpool",
                                "Best gym cleaning company Liverpool",
                                "Martial arts studio cleaning Liverpool",
                                "Pilates studio cleaning Liverpool",
                                "Gym floor cleaning Liverpool",
                                "Gym hygiene services Liverpool",
                                "Liverpool fitness cleaners"
                            ].map((keyword, index) => (
