...
export const metadata: Metadata = {
    title: "Office Cleaning Liverpool | Professional Cleaning Services",
    description: "Expert Office Cleaning in Liverpool. We are the top-rated cleaning company for Office Cleaning in Liverpool and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Commercial office cleaning Liverpool",
                                "Corporate cleaning Liverpool",
                                "Office cleaners Liverpool",
                                "Business cleaning services Liverpool",
                                "Professional office cleaners Liverpool",
                                "Daily office cleaning Liverpool",
                                "Office janitorial services Liverpool",
                                "Small office cleaning Liverpool",
                                "Large office cleaning Liverpool",
                                "Executive office cleaning Liverpool",
                                "Office sanitisation Liverpool",
                                "Workspace cleaning Liverpool",
                                "Desk cleaning services Liverpool",
                                "Reliable office cleaners Liverpool",
                                "Affordable office cleaning Liverpool",
                                "Office building cleaning Liverpool",
                                "Tech park cleaning Liverpool",
                                "Strata office cleaning Liverpool",
                                "Liverpool office cleaning company"
                            ].map((keyword, index) => (
