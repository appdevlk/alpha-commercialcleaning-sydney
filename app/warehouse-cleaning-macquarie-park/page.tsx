...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Macquarie Park | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Macquarie Park. We are the top-rated cleaning company for Warehouse Cleaning in Macquarie Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Macquarie Park",
                                "Industrial cleaning Macquarie Park",
                                "Factory cleaning Macquarie Park",
                                "Warehouse cleaners Macquarie Park",
                                "Distribution centre cleaning Macquarie Park",
                                "Warehouse floor cleaning Macquarie Park",
                                "Industrial sweep and scrub Macquarie Park",
                                "High pressure cleaning Macquarie Park",
                                "Workshop cleaning Macquarie Park",
                                "Manufacturing plant cleaning Macquarie Park",
                                "Warehouse dusting Macquarie Park",
                                "Bond warehouse cleaning Macquarie Park",
                                "End of lease warehouse cleaning Macquarie Park",
                                "Commercial warehouse cleaning Macquarie Park",
                                "Heavy duty cleaning Macquarie Park",
                                "Industrial degreasing Macquarie Park",
                                "Warehouse sanitisation Macquarie Park",
                                "Professional warehouse cleaners Macquarie Park",
                                "Storage facility cleaning Macquarie Park",
                                "Macquarie Park industrial cleaners"
                            ].map((keyword, index) => (
