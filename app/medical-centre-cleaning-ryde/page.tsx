...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Ryde. We are the top-rated cleaning company for Medical Centre Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Ryde",
                                "Healthcare cleaning services Ryde",
                                "Medical office cleaning Ryde",
                                "Dental clinic cleaning Ryde",
                                "Hospital grade cleaning Ryde",
                                "Clinical cleaning services Ryde",
                                "Medical facility cleaning Ryde",
                                "Doctor surgery cleaning Ryde",
                                "Professional medical cleaners Ryde",
                                "Sanitisation services Ryde",
                                "Medical cleaning company Ryde",
                                "Allied health cleaning Ryde",
                                "Pathology cleaning Ryde",
                                "Radiology cleaning services Ryde",
                                "Aged care cleaning Ryde",
                                "Infection control cleaning Ryde",
                                "Medical centre janitors Ryde",
                                "Commercial medical cleaning Ryde",
                                "Ryde medical cleaners",
                                "Sterile cleaning services Ryde"
                            ].map((keyword, index) => (
