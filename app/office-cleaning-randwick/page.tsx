...
export const metadata: Metadata = {
    title: "Office Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Office Cleaning in Randwick. We are the top-rated cleaning company for Office Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Randwick",
                                "Commercial office cleaning Randwick",
                                "Corporate cleaning Randwick",
                                "Office cleaners Randwick",
                                "Business cleaning services Randwick",
                                "Professional office cleaners Randwick",
                                "Daily office cleaning Randwick",
                                "Office janitorial services Randwick",
                                "Small office cleaning Randwick",
                                "Large office cleaning Randwick",
                                "Executive office cleaning Randwick",
                                "Office sanitisation Randwick",
                                "Workspace cleaning Randwick",
                                "Desk cleaning services Randwick",
                                "Reliable office cleaners Randwick",
                                "Affordable office cleaning Randwick",
                                "Office building cleaning Randwick",
                                "Tech park cleaning Randwick",
                                "Strata office cleaning Randwick",
                                "Randwick office cleaning company"
                            ].map((keyword, index) => (
