...
export const metadata: Metadata = {
    title: "Strata Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Randwick. We are the top-rated cleaning company for Strata Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Randwick",
                                "Strata cleaners Randwick",
                                "Body corporate cleaning Randwick",
                                "Building management cleaning Randwick",
                                "Apartment complex cleaning Randwick",
                                "Residential building cleaning Randwick",
                                "Common area cleaning Randwick",
                                "Strata maintenance Randwick",
                                "Condominium cleaning Randwick",
                                "High rise cleaning Randwick",
                                "Stairwell cleaning Randwick",
                                "Car park cleaning Randwick",
                                "Garbage management Randwick",
                                "Strata gardening and cleaning Randwick",
                                "Professional strata cleaners Randwick",
                                "Reliable strata cleaning Randwick",
                                "Strata cleaning rates Randwick",
                                "Sydney strata cleaning Randwick",
                                "Randwick strata services",
                                "Residential strata cleaning Randwick"
                            ].map((keyword, index) => (
