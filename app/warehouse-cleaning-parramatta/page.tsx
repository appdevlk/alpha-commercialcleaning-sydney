...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Parramatta | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Parramatta. We are the top-rated cleaning company for Warehouse Cleaning in Parramatta and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Parramatta",
                                "Industrial cleaning Parramatta",
                                "Factory cleaning Parramatta",
                                "Warehouse cleaners Parramatta",
                                "Distribution centre cleaning Parramatta",
                                "Warehouse floor cleaning Parramatta",
                                "Industrial sweep and scrub Parramatta",
                                "High pressure cleaning Parramatta",
                                "Workshop cleaning Parramatta",
                                "Manufacturing plant cleaning Parramatta",
                                "Warehouse dusting Parramatta",
                                "Bond warehouse cleaning Parramatta",
                                "End of lease warehouse cleaning Parramatta",
                                "Commercial warehouse cleaning Parramatta",
                                "Heavy duty cleaning Parramatta",
                                "Industrial degreasing Parramatta",
                                "Warehouse sanitisation Parramatta",
                                "Professional warehouse cleaners Parramatta",
                                "Storage facility cleaning Parramatta",
                                "Parramatta industrial cleaners"
                            ].map((keyword, index) => (
