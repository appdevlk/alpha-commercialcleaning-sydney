...
export const metadata: Metadata = {
    title: "Office Cleaning Blacktown | Professional Cleaning Services",
    description: "Expert Office Cleaning in Blacktown. We are the top-rated cleaning company for Office Cleaning in Blacktown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Blacktown",
                                "Commercial office cleaning Blacktown",
                                "Corporate cleaning Blacktown",
                                "Office cleaners Blacktown",
                                "Business cleaning services Blacktown",
                                "Professional office cleaners Blacktown",
                                "Daily office cleaning Blacktown",
                                "Office janitorial services Blacktown",
                                "Small office cleaning Blacktown",
                                "Large office cleaning Blacktown",
                                "Executive office cleaning Blacktown",
                                "Office sanitisation Blacktown",
                                "Workspace cleaning Blacktown",
                                "Desk cleaning services Blacktown",
                                "Reliable office cleaners Blacktown",
                                "Affordable office cleaning Blacktown",
                                "Office building cleaning Blacktown",
                                "Tech park cleaning Blacktown",
                                "Strata office cleaning Blacktown",
                                "Blacktown office cleaning company"
                            ].map((keyword, index) => (
