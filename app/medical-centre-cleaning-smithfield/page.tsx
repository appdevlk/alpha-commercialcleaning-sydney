...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Smithfield | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Smithfield. We are the top-rated cleaning company for Medical Centre Cleaning in Smithfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Smithfield",
                                "Medical office cleaning Smithfield",
                                "Dental clinic cleaning Smithfield",
                                "Hospital grade cleaning Smithfield",
                                "Clinical cleaning services Smithfield",
                                "Medical facility cleaning Smithfield",
                                "Doctor surgery cleaning Smithfield",
                                "Professional medical cleaners Smithfield",
                                "Sanitisation services Smithfield",
                                "Medical cleaning company Smithfield",
                                "Allied health cleaning Smithfield",
                                "Pathology cleaning Smithfield",
                                "Radiology cleaning services Smithfield",
                                "Aged care cleaning Smithfield",
                                "Infection control cleaning Smithfield",
                                "Medical centre janitors Smithfield",
                                "Commercial medical cleaning Smithfield",
                                "Smithfield medical cleaners",
                                "Sterile cleaning services Smithfield"
                            ].map((keyword, index) => (
