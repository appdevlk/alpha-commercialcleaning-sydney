...
export const metadata: Metadata = {
    title: "Commercial Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in St Marys. We are the top-rated cleaning company for Commercial Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services St Marys",
                                "Commercial cleaners St Marys",
                                "Business cleaning St Marys",
                                "Commercial cleaning company St Marys",
                                "Industrial cleaning St Marys",
                                "Retail cleaning St Marys",
                                "Showroom cleaning St Marys",
                                "Commercial property cleaning St Marys",
                                "Professional commercial cleaners St Marys",
                                "Commercial janitorial services St Marys",
                                "Local commercial cleaners St Marys",
                                "Event cleaning St Marys",
                                "Pub and club cleaning St Marys",
                                "Restaurant cleaning St Marys",
                                "Shopping centre cleaning St Marys",
                                "Commercial sanitisation St Marys",
                                "Office and commercial cleaning St Marys",
                                "Warehouse commercial cleaning St Marys",
                                "Best commercial cleaning St Marys",
                                "St Marys commercial cleaning services"
                            ].map((keyword, index) => (
