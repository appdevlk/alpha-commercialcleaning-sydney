...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Seven Hills | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Seven Hills. We are the top-rated cleaning company for Medical Centre Cleaning in Seven Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Seven Hills",
                                "Healthcare cleaning services Seven Hills",
                                "Medical office cleaning Seven Hills",
                                "Dental clinic cleaning Seven Hills",
                                "Hospital grade cleaning Seven Hills",
                                "Clinical cleaning services Seven Hills",
                                "Medical facility cleaning Seven Hills",
                                "Doctor surgery cleaning Seven Hills",
                                "Professional medical cleaners Seven Hills",
                                "Sanitisation services Seven Hills",
                                "Medical cleaning company Seven Hills",
                                "Allied health cleaning Seven Hills",
                                "Pathology cleaning Seven Hills",
                                "Radiology cleaning services Seven Hills",
                                "Aged care cleaning Seven Hills",
                                "Infection control cleaning Seven Hills",
                                "Medical centre janitors Seven Hills",
                                "Commercial medical cleaning Seven Hills",
                                "Seven Hills medical cleaners",
                                "Sterile cleaning services Seven Hills"
                            ].map((keyword, index) => (
