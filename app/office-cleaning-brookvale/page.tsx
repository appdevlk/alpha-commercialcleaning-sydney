...
export const metadata: Metadata = {
    title: "Office Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Office Cleaning in Brookvale. We are the top-rated cleaning company for Office Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Brookvale",
                                "Commercial office cleaning Brookvale",
                                "Corporate cleaning Brookvale",
                                "Office cleaners Brookvale",
                                "Business cleaning services Brookvale",
                                "Professional office cleaners Brookvale",
                                "Daily office cleaning Brookvale",
                                "Office janitorial services Brookvale",
                                "Small office cleaning Brookvale",
                                "Large office cleaning Brookvale",
                                "Executive office cleaning Brookvale",
                                "Office sanitisation Brookvale",
                                "Workspace cleaning Brookvale",
                                "Desk cleaning services Brookvale",
                                "Reliable office cleaners Brookvale",
                                "Affordable office cleaning Brookvale",
                                "Office building cleaning Brookvale",
                                "Tech park cleaning Brookvale",
                                "Strata office cleaning Brookvale",
                                "Brookvale office cleaning company"
                            ].map((keyword, index) => (
