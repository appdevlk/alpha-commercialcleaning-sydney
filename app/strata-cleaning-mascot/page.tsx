...
export const metadata: Metadata = {
    title: "Strata Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Mascot. We are the top-rated cleaning company for Strata Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Mascot",
                                "Strata cleaners Mascot",
                                "Body corporate cleaning Mascot",
                                "Building management cleaning Mascot",
                                "Apartment complex cleaning Mascot",
                                "Residential building cleaning Mascot",
                                "Common area cleaning Mascot",
                                "Strata maintenance Mascot",
                                "Condominium cleaning Mascot",
                                "High rise cleaning Mascot",
                                "Stairwell cleaning Mascot",
                                "Car park cleaning Mascot",
                                "Garbage management Mascot",
                                "Strata gardening and cleaning Mascot",
                                "Professional strata cleaners Mascot",
                                "Reliable strata cleaning Mascot",
                                "Strata cleaning rates Mascot",
                                "Sydney strata cleaning Mascot",
                                "Mascot strata services",
                                "Residential strata cleaning Mascot"
                            ].map((keyword, index) => (
