...
export const metadata: Metadata = {
    title: "Gym Cleaning Silverwater | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Silverwater. We are the top-rated cleaning company for Gym Cleaning in Silverwater and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Silverwater",
                                "Fitness centre cleaning Silverwater",
                                "Gym cleaners Silverwater",
                                "Yoga studio cleaning Silverwater",
                                "CrossFit gym cleaning Silverwater",
                                "Sports centre cleaning Silverwater",
                                "Gym equipment cleaning Silverwater",
                                "Health club cleaning Silverwater",
                                "Commercial gym cleaning Silverwater",
                                "Professional gym cleaners Silverwater",
                                "Gym sanitisation Silverwater",
                                "Fitness facility cleaning Silverwater",
                                "24/7 gym cleaning Silverwater",
                                "Local gym cleaners Silverwater",
                                "Best gym cleaning company Silverwater",
                                "Martial arts studio cleaning Silverwater",
                                "Pilates studio cleaning Silverwater",
                                "Gym floor cleaning Silverwater",
                                "Gym hygiene services Silverwater",
                                "Silverwater fitness cleaners"
                            ].map((keyword, index) => (
