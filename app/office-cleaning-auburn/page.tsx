...
export const metadata: Metadata = {
    title: "Office Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Office Cleaning in Auburn. We are the top-rated cleaning company for Office Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Auburn",
                                "Commercial office cleaning Auburn",
                                "Corporate cleaning Auburn",
                                "Office cleaners Auburn",
                                "Business cleaning services Auburn",
                                "Professional office cleaners Auburn",
                                "Daily office cleaning Auburn",
                                "Office janitorial services Auburn",
                                "Small office cleaning Auburn",
                                "Large office cleaning Auburn",
                                "Executive office cleaning Auburn",
                                "Office sanitisation Auburn",
                                "Workspace cleaning Auburn",
                                "Desk cleaning services Auburn",
                                "Reliable office cleaners Auburn",
                                "Affordable office cleaning Auburn",
                                "Office building cleaning Auburn",
                                "Tech park cleaning Auburn",
                                "Strata office cleaning Auburn",
                                "Auburn office cleaning company"
                            ].map((keyword, index) => (
