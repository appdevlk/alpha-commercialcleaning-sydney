...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Wetherill Park | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Wetherill Park. We are the top-rated cleaning company for Medical Centre Cleaning in Wetherill Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Wetherill Park",
                                "Medical office cleaning Wetherill Park",
                                "Dental clinic cleaning Wetherill Park",
                                "Hospital grade cleaning Wetherill Park",
                                "Clinical cleaning services Wetherill Park",
                                "Medical facility cleaning Wetherill Park",
                                "Doctor surgery cleaning Wetherill Park",
                                "Professional medical cleaners Wetherill Park",
                                "Sanitisation services Wetherill Park",
                                "Medical cleaning company Wetherill Park",
                                "Allied health cleaning Wetherill Park",
                                "Pathology cleaning Wetherill Park",
                                "Radiology cleaning services Wetherill Park",
                                "Aged care cleaning Wetherill Park",
                                "Infection control cleaning Wetherill Park",
                                "Medical centre janitors Wetherill Park",
                                "Commercial medical cleaning Wetherill Park",
                                "Wetherill Park medical cleaners",
                                "Sterile cleaning services Wetherill Park"
                            ].map((keyword, index) => (
