...
export const metadata: Metadata = {
    title: "Commercial Cleaning Parramatta | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Parramatta. We are the top-rated cleaning company for Commercial Cleaning in Parramatta and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Parramatta",
                                "Commercial cleaners Parramatta",
                                "Business cleaning Parramatta",
                                "Commercial cleaning company Parramatta",
                                "Industrial cleaning Parramatta",
                                "Retail cleaning Parramatta",
                                "Showroom cleaning Parramatta",
                                "Commercial property cleaning Parramatta",
                                "Professional commercial cleaners Parramatta",
                                "Commercial janitorial services Parramatta",
                                "Local commercial cleaners Parramatta",
                                "Event cleaning Parramatta",
                                "Pub and club cleaning Parramatta",
                                "Restaurant cleaning Parramatta",
                                "Shopping centre cleaning Parramatta",
                                "Commercial sanitisation Parramatta",
                                "Office and commercial cleaning Parramatta",
                                "Warehouse commercial cleaning Parramatta",
                                "Best commercial cleaning Parramatta",
                                "Parramatta commercial cleaning services"
                            ].map((keyword, index) => (
