...
export const metadata: Metadata = {
    title: "Strata Cleaning Silverwater | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Silverwater. We are the top-rated cleaning company for Strata Cleaning in Silverwater and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Silverwater",
                                "Strata cleaners Silverwater",
                                "Body corporate cleaning Silverwater",
                                "Building management cleaning Silverwater",
                                "Apartment complex cleaning Silverwater",
                                "Residential building cleaning Silverwater",
                                "Common area cleaning Silverwater",
                                "Strata maintenance Silverwater",
                                "Condominium cleaning Silverwater",
                                "High rise cleaning Silverwater",
                                "Stairwell cleaning Silverwater",
                                "Car park cleaning Silverwater",
                                "Garbage management Silverwater",
                                "Strata gardening and cleaning Silverwater",
                                "Professional strata cleaners Silverwater",
                                "Reliable strata cleaning Silverwater",
                                "Strata cleaning rates Silverwater",
                                "Sydney strata cleaning Silverwater",
                                "Silverwater strata services",
                                "Residential strata cleaning Silverwater"
                            ].map((keyword, index) => (
