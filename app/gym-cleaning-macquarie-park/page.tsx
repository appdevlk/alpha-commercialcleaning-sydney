...
export const metadata: Metadata = {
    title: "Gym Cleaning Macquarie Park | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Macquarie Park. We are the top-rated cleaning company for Gym Cleaning in Macquarie Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Macquarie Park",
                                "Fitness centre cleaning Macquarie Park",
                                "Gym cleaners Macquarie Park",
                                "Yoga studio cleaning Macquarie Park",
                                "CrossFit gym cleaning Macquarie Park",
                                "Sports centre cleaning Macquarie Park",
                                "Gym equipment cleaning Macquarie Park",
                                "Health club cleaning Macquarie Park",
                                "Commercial gym cleaning Macquarie Park",
                                "Professional gym cleaners Macquarie Park",
                                "Gym sanitisation Macquarie Park",
                                "Fitness facility cleaning Macquarie Park",
                                "24/7 gym cleaning Macquarie Park",
                                "Local gym cleaners Macquarie Park",
                                "Best gym cleaning company Macquarie Park",
                                "Martial arts studio cleaning Macquarie Park",
                                "Pilates studio cleaning Macquarie Park",
                                "Gym floor cleaning Macquarie Park",
                                "Gym hygiene services Macquarie Park",
                                "Macquarie Park fitness cleaners"
                            ].map((keyword, index) => (
