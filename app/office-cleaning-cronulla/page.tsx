...
export const metadata: Metadata = {
    title: "Office Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Office Cleaning in Cronulla. We are the top-rated cleaning company for Office Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Cronulla",
                                "Commercial office cleaning Cronulla",
                                "Corporate cleaning Cronulla",
                                "Office cleaners Cronulla",
                                "Business cleaning services Cronulla",
                                "Professional office cleaners Cronulla",
                                "Daily office cleaning Cronulla",
                                "Office janitorial services Cronulla",
                                "Small office cleaning Cronulla",
                                "Large office cleaning Cronulla",
                                "Executive office cleaning Cronulla",
                                "Office sanitisation Cronulla",
                                "Workspace cleaning Cronulla",
                                "Desk cleaning services Cronulla",
                                "Reliable office cleaners Cronulla",
                                "Affordable office cleaning Cronulla",
                                "Office building cleaning Cronulla",
                                "Tech park cleaning Cronulla",
                                "Strata office cleaning Cronulla",
                                "Cronulla office cleaning company"
                            ].map((keyword, index) => (
