...
export const metadata: Metadata = {
    title: "Commercial Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Burwood. We are the top-rated cleaning company for Commercial Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Burwood",
                                "Commercial cleaners Burwood",
                                "Business cleaning Burwood",
                                "Commercial cleaning company Burwood",
                                "Industrial cleaning Burwood",
                                "Retail cleaning Burwood",
                                "Showroom cleaning Burwood",
                                "Commercial property cleaning Burwood",
                                "Professional commercial cleaners Burwood",
                                "Commercial janitorial services Burwood",
                                "Local commercial cleaners Burwood",
                                "Event cleaning Burwood",
                                "Pub and club cleaning Burwood",
                                "Restaurant cleaning Burwood",
                                "Shopping centre cleaning Burwood",
                                "Commercial sanitisation Burwood",
                                "Office and commercial cleaning Burwood",
                                "Warehouse commercial cleaning Burwood",
                                "Best commercial cleaning Burwood",
                                "Burwood commercial cleaning services"
                            ].map((keyword, index) => (
