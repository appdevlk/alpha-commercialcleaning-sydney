...
export const metadata: Metadata = {
    title: "Gym Cleaning Seven Hills | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Seven Hills. We are the top-rated cleaning company for Gym Cleaning in Seven Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Seven Hills",
                                "Fitness centre cleaning Seven Hills",
                                "Gym cleaners Seven Hills",
                                "Yoga studio cleaning Seven Hills",
                                "CrossFit gym cleaning Seven Hills",
                                "Sports centre cleaning Seven Hills",
                                "Gym equipment cleaning Seven Hills",
                                "Health club cleaning Seven Hills",
                                "Commercial gym cleaning Seven Hills",
                                "Professional gym cleaners Seven Hills",
                                "Gym sanitisation Seven Hills",
                                "Fitness facility cleaning Seven Hills",
                                "24/7 gym cleaning Seven Hills",
                                "Local gym cleaners Seven Hills",
                                "Best gym cleaning company Seven Hills",
                                "Martial arts studio cleaning Seven Hills",
                                "Pilates studio cleaning Seven Hills",
                                "Gym floor cleaning Seven Hills",
                                "Gym hygiene services Seven Hills",
                                "Seven Hills fitness cleaners"
                            ].map((keyword, index) => (
