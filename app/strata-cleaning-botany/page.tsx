...
export const metadata: Metadata = {
    title: "Strata Cleaning Botany | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Botany. We are the top-rated cleaning company for Strata Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Botany",
                                "Strata cleaners Botany",
                                "Body corporate cleaning Botany",
                                "Building management cleaning Botany",
                                "Apartment complex cleaning Botany",
                                "Residential building cleaning Botany",
                                "Common area cleaning Botany",
                                "Strata maintenance Botany",
                                "Condominium cleaning Botany",
                                "High rise cleaning Botany",
                                "Stairwell cleaning Botany",
                                "Car park cleaning Botany",
                                "Garbage management Botany",
                                "Strata gardening and cleaning Botany",
                                "Professional strata cleaners Botany",
                                "Reliable strata cleaning Botany",
                                "Strata cleaning rates Botany",
                                "Sydney strata cleaning Botany",
                                "Botany strata services",
                                "Residential strata cleaning Botany"
                            ].map((keyword, index) => (
