...
export const metadata: Metadata = {
    title: "Commercial Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Hurstville. We are the top-rated cleaning company for Commercial Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Hurstville",
                                "Commercial cleaners Hurstville",
                                "Business cleaning Hurstville",
                                "Commercial cleaning company Hurstville",
                                "Industrial cleaning Hurstville",
                                "Retail cleaning Hurstville",
                                "Showroom cleaning Hurstville",
                                "Commercial property cleaning Hurstville",
                                "Professional commercial cleaners Hurstville",
                                "Commercial janitorial services Hurstville",
                                "Local commercial cleaners Hurstville",
                                "Event cleaning Hurstville",
                                "Pub and club cleaning Hurstville",
                                "Restaurant cleaning Hurstville",
                                "Shopping centre cleaning Hurstville",
                                "Commercial sanitisation Hurstville",
                                "Office and commercial cleaning Hurstville",
                                "Warehouse commercial cleaning Hurstville",
                                "Best commercial cleaning Hurstville",
                                "Hurstville commercial cleaning services"
                            ].map((keyword, index) => (
