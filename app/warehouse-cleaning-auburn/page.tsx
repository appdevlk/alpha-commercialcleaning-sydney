...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Auburn. We are the top-rated cleaning company for Warehouse Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Auburn",
                                "Industrial cleaning Auburn",
                                "Factory cleaning Auburn",
                                "Warehouse cleaners Auburn",
                                "Distribution centre cleaning Auburn",
                                "Warehouse floor cleaning Auburn",
                                "Industrial sweep and scrub Auburn",
                                "High pressure cleaning Auburn",
                                "Workshop cleaning Auburn",
                                "Manufacturing plant cleaning Auburn",
                                "Warehouse dusting Auburn",
                                "Bond warehouse cleaning Auburn",
                                "End of lease warehouse cleaning Auburn",
                                "Commercial warehouse cleaning Auburn",
                                "Heavy duty cleaning Auburn",
                                "Industrial degreasing Auburn",
                                "Warehouse sanitisation Auburn",
                                "Professional warehouse cleaners Auburn",
                                "Storage facility cleaning Auburn",
                                "Auburn industrial cleaners"
                            ].map((keyword, index) => (
