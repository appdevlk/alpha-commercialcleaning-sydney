...
export const metadata: Metadata = {
    title: "Office Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Office Cleaning in Penrith. We are the top-rated cleaning company for Office Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Penrith",
                                "Commercial office cleaning Penrith",
                                "Corporate cleaning Penrith",
                                "Office cleaners Penrith",
                                "Business cleaning services Penrith",
                                "Professional office cleaners Penrith",
                                "Daily office cleaning Penrith",
                                "Office janitorial services Penrith",
                                "Small office cleaning Penrith",
                                "Large office cleaning Penrith",
                                "Executive office cleaning Penrith",
                                "Office sanitisation Penrith",
                                "Workspace cleaning Penrith",
                                "Desk cleaning services Penrith",
                                "Reliable office cleaners Penrith",
                                "Affordable office cleaning Penrith",
                                "Office building cleaning Penrith",
                                "Tech park cleaning Penrith",
                                "Strata office cleaning Penrith",
                                "Penrith office cleaning company"
                            ].map((keyword, index) => (
