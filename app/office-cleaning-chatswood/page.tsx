...
export const metadata: Metadata = {
    title: "Office Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Office Cleaning in Chatswood. We are the top-rated cleaning company for Office Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Chatswood",
                                "Commercial office cleaning Chatswood",
                                "Corporate cleaning Chatswood",
                                "Office cleaners Chatswood",
                                "Business cleaning services Chatswood",
                                "Professional office cleaners Chatswood",
                                "Daily office cleaning Chatswood",
                                "Office janitorial services Chatswood",
                                "Small office cleaning Chatswood",
                                "Large office cleaning Chatswood",
                                "Executive office cleaning Chatswood",
                                "Office sanitisation Chatswood",
                                "Workspace cleaning Chatswood",
                                "Desk cleaning services Chatswood",
                                "Reliable office cleaners Chatswood",
                                "Affordable office cleaning Chatswood",
                                "Office building cleaning Chatswood",
                                "Tech park cleaning Chatswood",
                                "Strata office cleaning Chatswood",
                                "Chatswood office cleaning company"
                            ].map((keyword, index) => (
