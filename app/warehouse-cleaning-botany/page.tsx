...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Botany | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Botany. We are the top-rated cleaning company for Warehouse Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Botany",
                                "Industrial cleaning Botany",
                                "Factory cleaning Botany",
                                "Warehouse cleaners Botany",
                                "Distribution centre cleaning Botany",
                                "Warehouse floor cleaning Botany",
                                "Industrial sweep and scrub Botany",
                                "High pressure cleaning Botany",
                                "Workshop cleaning Botany",
                                "Manufacturing plant cleaning Botany",
                                "Warehouse dusting Botany",
                                "Bond warehouse cleaning Botany",
                                "End of lease warehouse cleaning Botany",
                                "Commercial warehouse cleaning Botany",
                                "Heavy duty cleaning Botany",
                                "Industrial degreasing Botany",
                                "Warehouse sanitisation Botany",
                                "Professional warehouse cleaners Botany",
                                "Storage facility cleaning Botany",
                                "Botany industrial cleaners"
                            ].map((keyword, index) => (
