...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Burwood. We are the top-rated cleaning company for Medical Centre Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Burwood",
                                "Healthcare cleaning services Burwood",
                                "Medical office cleaning Burwood",
                                "Dental clinic cleaning Burwood",
                                "Hospital grade cleaning Burwood",
                                "Clinical cleaning services Burwood",
                                "Medical facility cleaning Burwood",
                                "Doctor surgery cleaning Burwood",
                                "Professional medical cleaners Burwood",
                                "Sanitisation services Burwood",
                                "Medical cleaning company Burwood",
                                "Allied health cleaning Burwood",
                                "Pathology cleaning Burwood",
                                "Radiology cleaning services Burwood",
                                "Aged care cleaning Burwood",
                                "Infection control cleaning Burwood",
                                "Medical centre janitors Burwood",
                                "Commercial medical cleaning Burwood",
                                "Burwood medical cleaners",
                                "Sterile cleaning services Burwood"
                            ].map((keyword, index) => (
