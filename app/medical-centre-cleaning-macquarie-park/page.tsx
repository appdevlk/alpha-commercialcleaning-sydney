...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Macquarie Park | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Macquarie Park. We are the top-rated cleaning company for Medical Centre Cleaning in Macquarie Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Macquarie Park",
                                "Healthcare cleaning services Macquarie Park",
                                "Medical office cleaning Macquarie Park",
                                "Dental clinic cleaning Macquarie Park",
                                "Hospital grade cleaning Macquarie Park",
                                "Clinical cleaning services Macquarie Park",
                                "Medical facility cleaning Macquarie Park",
                                "Doctor surgery cleaning Macquarie Park",
                                "Professional medical cleaners Macquarie Park",
                                "Sanitisation services Macquarie Park",
                                "Medical cleaning company Macquarie Park",
                                "Allied health cleaning Macquarie Park",
                                "Pathology cleaning Macquarie Park",
                                "Radiology cleaning services Macquarie Park",
                                "Aged care cleaning Macquarie Park",
                                "Infection control cleaning Macquarie Park",
                                "Medical centre janitors Macquarie Park",
                                "Commercial medical cleaning Macquarie Park",
                                "Macquarie Park medical cleaners",
                                "Sterile cleaning services Macquarie Park"
                            ].map((keyword, index) => (
