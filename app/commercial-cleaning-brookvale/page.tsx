...
export const metadata: Metadata = {
    title: "Commercial Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Brookvale. We are the top-rated cleaning company for Commercial Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Brookvale",
                                "Commercial cleaners Brookvale",
                                "Business cleaning Brookvale",
                                "Commercial cleaning company Brookvale",
                                "Industrial cleaning Brookvale",
                                "Retail cleaning Brookvale",
                                "Showroom cleaning Brookvale",
                                "Commercial property cleaning Brookvale",
                                "Professional commercial cleaners Brookvale",
                                "Commercial janitorial services Brookvale",
                                "Local commercial cleaners Brookvale",
                                "Event cleaning Brookvale",
                                "Pub and club cleaning Brookvale",
                                "Restaurant cleaning Brookvale",
                                "Shopping centre cleaning Brookvale",
                                "Commercial sanitisation Brookvale",
                                "Office and commercial cleaning Brookvale",
                                "Warehouse commercial cleaning Brookvale",
                                "Best commercial cleaning Brookvale",
                                "Brookvale commercial cleaning services"
                            ].map((keyword, index) => (
