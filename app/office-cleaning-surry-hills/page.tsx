...
export const metadata: Metadata = {
    title: "Office Cleaning Surry Hills | Professional Cleaning Services",
    description: "Expert Office Cleaning in Surry Hills. We are the top-rated cleaning company for Office Cleaning in Surry Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Surry Hills",
                                "Commercial office cleaning Surry Hills",
                                "Corporate cleaning Surry Hills",
                                "Office cleaners Surry Hills",
                                "Business cleaning services Surry Hills",
                                "Professional office cleaners Surry Hills",
                                "Daily office cleaning Surry Hills",
                                "Office janitorial services Surry Hills",
                                "Small office cleaning Surry Hills",
                                "Large office cleaning Surry Hills",
                                "Executive office cleaning Surry Hills",
                                "Office sanitisation Surry Hills",
                                "Workspace cleaning Surry Hills",
                                "Desk cleaning services Surry Hills",
                                "Reliable office cleaners Surry Hills",
                                "Affordable office cleaning Surry Hills",
                                "Office building cleaning Surry Hills",
                                "Tech park cleaning Surry Hills",
                                "Strata office cleaning Surry Hills",
                                "Surry Hills office cleaning company"
                            ].map((keyword, index) => (
