...
export const metadata: Metadata = {
    title: "Gym Cleaning Surry Hills | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Surry Hills. We are the top-rated cleaning company for Gym Cleaning in Surry Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Surry Hills",
                                "Fitness centre cleaning Surry Hills",
                                "Gym cleaners Surry Hills",
                                "Yoga studio cleaning Surry Hills",
                                "CrossFit gym cleaning Surry Hills",
                                "Sports centre cleaning Surry Hills",
                                "Gym equipment cleaning Surry Hills",
                                "Health club cleaning Surry Hills",
                                "Commercial gym cleaning Surry Hills",
                                "Professional gym cleaners Surry Hills",
                                "Gym sanitisation Surry Hills",
                                "Fitness facility cleaning Surry Hills",
                                "24/7 gym cleaning Surry Hills",
                                "Local gym cleaners Surry Hills",
                                "Best gym cleaning company Surry Hills",
                                "Martial arts studio cleaning Surry Hills",
                                "Pilates studio cleaning Surry Hills",
                                "Gym floor cleaning Surry Hills",
                                "Gym hygiene services Surry Hills",
                                "Surry Hills fitness cleaners"
                            ].map((keyword, index) => (
