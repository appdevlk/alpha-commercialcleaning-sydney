...
export const metadata: Metadata = {
    title: "Office Cleaning Kellyville | Professional Cleaning Services",
    description: "Expert Office Cleaning in Kellyville. We are the top-rated cleaning company for Office Cleaning in Kellyville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Kellyville",
                                "Commercial office cleaning Kellyville",
                                "Corporate cleaning Kellyville",
                                "Office cleaners Kellyville",
                                "Business cleaning services Kellyville",
                                "Professional office cleaners Kellyville",
                                "Daily office cleaning Kellyville",
                                "Office janitorial services Kellyville",
                                "Small office cleaning Kellyville",
                                "Large office cleaning Kellyville",
                                "Executive office cleaning Kellyville",
                                "Office sanitisation Kellyville",
                                "Workspace cleaning Kellyville",
                                "Desk cleaning services Kellyville",
                                "Reliable office cleaners Kellyville",
                                "Affordable office cleaning Kellyville",
                                "Office building cleaning Kellyville",
                                "Tech park cleaning Kellyville",
                                "Strata office cleaning Kellyville",
                                "Kellyville office cleaning company"
                            ].map((keyword, index) => (
