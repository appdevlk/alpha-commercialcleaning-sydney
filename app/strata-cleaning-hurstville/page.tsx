...
export const metadata: Metadata = {
    title: "Strata Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Hurstville. We are the top-rated cleaning company for Strata Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Hurstville",
                                "Strata cleaners Hurstville",
                                "Body corporate cleaning Hurstville",
                                "Building management cleaning Hurstville",
                                "Apartment complex cleaning Hurstville",
                                "Residential building cleaning Hurstville",
                                "Common area cleaning Hurstville",
                                "Strata maintenance Hurstville",
                                "Condominium cleaning Hurstville",
                                "High rise cleaning Hurstville",
                                "Stairwell cleaning Hurstville",
                                "Car park cleaning Hurstville",
                                "Garbage management Hurstville",
                                "Strata gardening and cleaning Hurstville",
                                "Professional strata cleaners Hurstville",
                                "Reliable strata cleaning Hurstville",
                                "Strata cleaning rates Hurstville",
                                "Sydney strata cleaning Hurstville",
                                "Hurstville strata services",
                                "Residential strata cleaning Hurstville"
                            ].map((keyword, index) => (
