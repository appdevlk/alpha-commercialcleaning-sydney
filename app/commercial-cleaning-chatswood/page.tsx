...
export const metadata: Metadata = {
    title: "Commercial Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Chatswood. We are the top-rated cleaning company for Commercial Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Chatswood",
                                "Commercial cleaners Chatswood",
                                "Business cleaning Chatswood",
                                "Commercial cleaning company Chatswood",
                                "Industrial cleaning Chatswood",
                                "Retail cleaning Chatswood",
                                "Showroom cleaning Chatswood",
                                "Commercial property cleaning Chatswood",
                                "Professional commercial cleaners Chatswood",
                                "Commercial janitorial services Chatswood",
                                "Local commercial cleaners Chatswood",
                                "Event cleaning Chatswood",
                                "Pub and club cleaning Chatswood",
                                "Restaurant cleaning Chatswood",
                                "Shopping centre cleaning Chatswood",
                                "Commercial sanitisation Chatswood",
                                "Office and commercial cleaning Chatswood",
                                "Warehouse commercial cleaning Chatswood",
                                "Best commercial cleaning Chatswood",
                                "Chatswood commercial cleaning services"
                            ].map((keyword, index) => (
