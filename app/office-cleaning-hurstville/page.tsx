...
export const metadata: Metadata = {
    title: "Office Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Office Cleaning in Hurstville. We are the top-rated cleaning company for Office Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Hurstville",
                                "Commercial office cleaning Hurstville",
                                "Corporate cleaning Hurstville",
                                "Office cleaners Hurstville",
                                "Business cleaning services Hurstville",
                                "Professional office cleaners Hurstville",
                                "Daily office cleaning Hurstville",
                                "Office janitorial services Hurstville",
                                "Small office cleaning Hurstville",
                                "Large office cleaning Hurstville",
                                "Executive office cleaning Hurstville",
                                "Office sanitisation Hurstville",
                                "Workspace cleaning Hurstville",
                                "Desk cleaning services Hurstville",
                                "Reliable office cleaners Hurstville",
                                "Affordable office cleaning Hurstville",
                                "Office building cleaning Hurstville",
                                "Tech park cleaning Hurstville",
                                "Strata office cleaning Hurstville",
                                "Hurstville office cleaning company"
                            ].map((keyword, index) => (
