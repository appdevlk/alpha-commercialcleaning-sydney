...
export const metadata: Metadata = {
    title: "Gym Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Randwick. We are the top-rated cleaning company for Gym Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Randwick",
                                "Fitness centre cleaning Randwick",
                                "Gym cleaners Randwick",
                                "Yoga studio cleaning Randwick",
                                "CrossFit gym cleaning Randwick",
                                "Sports centre cleaning Randwick",
                                "Gym equipment cleaning Randwick",
                                "Health club cleaning Randwick",
                                "Commercial gym cleaning Randwick",
                                "Professional gym cleaners Randwick",
                                "Gym sanitisation Randwick",
                                "Fitness facility cleaning Randwick",
                                "24/7 gym cleaning Randwick",
                                "Local gym cleaners Randwick",
                                "Best gym cleaning company Randwick",
                                "Martial arts studio cleaning Randwick",
                                "Pilates studio cleaning Randwick",
                                "Gym floor cleaning Randwick",
                                "Gym hygiene services Randwick",
                                "Randwick fitness cleaners"
                            ].map((keyword, index) => (
