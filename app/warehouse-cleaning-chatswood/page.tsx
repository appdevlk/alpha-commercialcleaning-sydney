...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Chatswood. We are the top-rated cleaning company for Warehouse Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Chatswood",
                                "Industrial cleaning Chatswood",
                                "Factory cleaning Chatswood",
                                "Warehouse cleaners Chatswood",
                                "Distribution centre cleaning Chatswood",
                                "Warehouse floor cleaning Chatswood",
                                "Industrial sweep and scrub Chatswood",
                                "High pressure cleaning Chatswood",
                                "Workshop cleaning Chatswood",
                                "Manufacturing plant cleaning Chatswood",
                                "Warehouse dusting Chatswood",
                                "Bond warehouse cleaning Chatswood",
                                "End of lease warehouse cleaning Chatswood",
                                "Commercial warehouse cleaning Chatswood",
                                "Heavy duty cleaning Chatswood",
                                "Industrial degreasing Chatswood",
                                "Warehouse sanitisation Chatswood",
                                "Professional warehouse cleaners Chatswood",
                                "Storage facility cleaning Chatswood",
                                "Chatswood industrial cleaners"
                            ].map((keyword, index) => (
