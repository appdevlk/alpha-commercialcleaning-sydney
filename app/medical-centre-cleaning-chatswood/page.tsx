...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Chatswood. We are the top-rated cleaning company for Medical Centre Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Chatswood",
                                "Healthcare cleaning services Chatswood",
                                "Medical office cleaning Chatswood",
                                "Dental clinic cleaning Chatswood",
                                "Hospital grade cleaning Chatswood",
                                "Clinical cleaning services Chatswood",
                                "Medical facility cleaning Chatswood",
                                "Doctor surgery cleaning Chatswood",
                                "Professional medical cleaners Chatswood",
                                "Sanitisation services Chatswood",
                                "Medical cleaning company Chatswood",
                                "Allied health cleaning Chatswood",
                                "Pathology cleaning Chatswood",
                                "Radiology cleaning services Chatswood",
                                "Aged care cleaning Chatswood",
                                "Infection control cleaning Chatswood",
                                "Medical centre janitors Chatswood",
                                "Commercial medical cleaning Chatswood",
                                "Chatswood medical cleaners",
                                "Sterile cleaning services Chatswood"
                            ].map((keyword, index) => (
