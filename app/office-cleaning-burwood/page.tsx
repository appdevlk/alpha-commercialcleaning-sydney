...
export const metadata: Metadata = {
    title: "Office Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Office Cleaning in Burwood. We are the top-rated cleaning company for Office Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Burwood",
                                "Commercial office cleaning Burwood",
                                "Corporate cleaning Burwood",
                                "Office cleaners Burwood",
                                "Business cleaning services Burwood",
                                "Professional office cleaners Burwood",
                                "Daily office cleaning Burwood",
                                "Office janitorial services Burwood",
                                "Small office cleaning Burwood",
                                "Large office cleaning Burwood",
                                "Executive office cleaning Burwood",
                                "Office sanitisation Burwood",
                                "Workspace cleaning Burwood",
                                "Desk cleaning services Burwood",
                                "Reliable office cleaners Burwood",
                                "Affordable office cleaning Burwood",
                                "Office building cleaning Burwood",
                                "Tech park cleaning Burwood",
                                "Strata office cleaning Burwood",
                                "Burwood office cleaning company"
                            ].map((keyword, index) => (
