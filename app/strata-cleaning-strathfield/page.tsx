...
export const metadata: Metadata = {
    title: "Strata Cleaning Strathfield | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Strathfield. We are the top-rated cleaning company for Strata Cleaning in Strathfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Strathfield",
                                "Strata cleaners Strathfield",
                                "Body corporate cleaning Strathfield",
                                "Building management cleaning Strathfield",
                                "Apartment complex cleaning Strathfield",
                                "Residential building cleaning Strathfield",
                                "Common area cleaning Strathfield",
                                "Strata maintenance Strathfield",
                                "Condominium cleaning Strathfield",
                                "High rise cleaning Strathfield",
                                "Stairwell cleaning Strathfield",
                                "Car park cleaning Strathfield",
                                "Garbage management Strathfield",
                                "Strata gardening and cleaning Strathfield",
                                "Professional strata cleaners Strathfield",
                                "Reliable strata cleaning Strathfield",
                                "Strata cleaning rates Strathfield",
                                "Sydney strata cleaning Strathfield",
                                "Strathfield strata services",
                                "Residential strata cleaning Strathfield"
                            ].map((keyword, index) => (
