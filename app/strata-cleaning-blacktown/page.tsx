...
export const metadata: Metadata = {
    title: "Strata Cleaning Blacktown | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Blacktown. We are the top-rated cleaning company for Strata Cleaning in Blacktown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Blacktown",
                                "Strata cleaners Blacktown",
                                "Body corporate cleaning Blacktown",
                                "Building management cleaning Blacktown",
                                "Apartment complex cleaning Blacktown",
                                "Residential building cleaning Blacktown",
                                "Common area cleaning Blacktown",
                                "Strata maintenance Blacktown",
                                "Condominium cleaning Blacktown",
                                "High rise cleaning Blacktown",
                                "Stairwell cleaning Blacktown",
                                "Car park cleaning Blacktown",
                                "Garbage management Blacktown",
                                "Strata gardening and cleaning Blacktown",
                                "Professional strata cleaners Blacktown",
                                "Reliable strata cleaning Blacktown",
                                "Strata cleaning rates Blacktown",
                                "Sydney strata cleaning Blacktown",
                                "Blacktown strata services",
                                "Residential strata cleaning Blacktown"
                            ].map((keyword, index) => (
