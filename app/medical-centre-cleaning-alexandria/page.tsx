...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Alexandria. We are the top-rated cleaning company for Medical Centre Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Alexandria",
                                "Medical office cleaning Alexandria",
                                "Dental clinic cleaning Alexandria",
                                "Hospital grade cleaning Alexandria",
                                "Clinical cleaning services Alexandria",
                                "Medical facility cleaning Alexandria",
                                "Doctor surgery cleaning Alexandria",
                                "Professional medical cleaners Alexandria",
                                "Sanitisation services Alexandria",
                                "Medical cleaning company Alexandria",
                                "Allied health cleaning Alexandria",
                                "Pathology cleaning Alexandria",
                                "Radiology cleaning services Alexandria",
                                "Aged care cleaning Alexandria",
                                "Infection control cleaning Alexandria",
                                "Medical centre janitors Alexandria",
                                "Commercial medical cleaning Alexandria",
                                "Alexandria medical cleaners",
                                "Sterile cleaning services Alexandria"
                            ].map((keyword, index) => (
