...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Mascot. We are the top-rated cleaning company for Medical Centre Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Mascot",
                                "Healthcare cleaning services Mascot",
                                "Medical office cleaning Mascot",
                                "Dental clinic cleaning Mascot",
                                "Hospital grade cleaning Mascot",
                                "Clinical cleaning services Mascot",
                                "Medical facility cleaning Mascot",
                                "Doctor surgery cleaning Mascot",
                                "Professional medical cleaners Mascot",
                                "Sanitisation services Mascot",
                                "Medical cleaning company Mascot",
                                "Allied health cleaning Mascot",
                                "Pathology cleaning Mascot",
                                "Radiology cleaning services Mascot",
                                "Aged care cleaning Mascot",
                                "Infection control cleaning Mascot",
                                "Medical centre janitors Mascot",
                                "Commercial medical cleaning Mascot",
                                "Mascot medical cleaners",
                                "Sterile cleaning services Mascot"
                            ].map((keyword, index) => (
