...
export const metadata: Metadata = {
    title: "Commercial Cleaning Blacktown | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Blacktown. We are the top-rated cleaning company for Commercial Cleaning in Blacktown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Blacktown",
                                "Commercial cleaners Blacktown",
                                "Business cleaning Blacktown",
                                "Commercial cleaning company Blacktown",
                                "Industrial cleaning Blacktown",
                                "Retail cleaning Blacktown",
                                "Showroom cleaning Blacktown",
                                "Commercial property cleaning Blacktown",
                                "Professional commercial cleaners Blacktown",
                                "Commercial janitorial services Blacktown",
                                "Local commercial cleaners Blacktown",
                                "Event cleaning Blacktown",
                                "Pub and club cleaning Blacktown",
                                "Restaurant cleaning Blacktown",
                                "Shopping centre cleaning Blacktown",
                                "Commercial sanitisation Blacktown",
                                "Office and commercial cleaning Blacktown",
                                "Warehouse commercial cleaning Blacktown",
                                "Best commercial cleaning Blacktown",
                                "Blacktown commercial cleaning services"
                            ].map((keyword, index) => (
