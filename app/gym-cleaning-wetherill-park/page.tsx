...
export const metadata: Metadata = {
    title: "Gym Cleaning Wetherill Park | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Wetherill Park. We are the top-rated cleaning company for Gym Cleaning in Wetherill Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Wetherill Park",
                                "Fitness centre cleaning Wetherill Park",
                                "Gym cleaners Wetherill Park",
                                "Yoga studio cleaning Wetherill Park",
                                "CrossFit gym cleaning Wetherill Park",
                                "Sports centre cleaning Wetherill Park",
                                "Gym equipment cleaning Wetherill Park",
                                "Health club cleaning Wetherill Park",
                                "Commercial gym cleaning Wetherill Park",
                                "Professional gym cleaners Wetherill Park",
                                "Gym sanitisation Wetherill Park",
                                "Fitness facility cleaning Wetherill Park",
                                "24/7 gym cleaning Wetherill Park",
                                "Local gym cleaners Wetherill Park",
                                "Best gym cleaning company Wetherill Park",
                                "Martial arts studio cleaning Wetherill Park",
                                "Pilates studio cleaning Wetherill Park",
                                "Gym floor cleaning Wetherill Park",
                                "Gym hygiene services Wetherill Park",
                                "Wetherill Park fitness cleaners"
                            ].map((keyword, index) => (
