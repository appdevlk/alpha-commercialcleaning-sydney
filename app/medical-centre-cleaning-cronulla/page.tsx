...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Cronulla. We are the top-rated cleaning company for Medical Centre Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Cronulla",
                                "Healthcare cleaning services Cronulla",
                                "Medical office cleaning Cronulla",
                                "Dental clinic cleaning Cronulla",
                                "Hospital grade cleaning Cronulla",
                                "Clinical cleaning services Cronulla",
                                "Medical facility cleaning Cronulla",
                                "Doctor surgery cleaning Cronulla",
                                "Professional medical cleaners Cronulla",
                                "Sanitisation services Cronulla",
                                "Medical cleaning company Cronulla",
                                "Allied health cleaning Cronulla",
                                "Pathology cleaning Cronulla",
                                "Radiology cleaning services Cronulla",
                                "Aged care cleaning Cronulla",
                                "Infection control cleaning Cronulla",
                                "Medical centre janitors Cronulla",
                                "Commercial medical cleaning Cronulla",
                                "Cronulla medical cleaners",
                                "Sterile cleaning services Cronulla"
                            ].map((keyword, index) => (
