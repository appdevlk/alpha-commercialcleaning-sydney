...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Silverwater | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Silverwater. We are the top-rated cleaning company for Warehouse Cleaning in Silverwater and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Silverwater",
                                "Industrial cleaning Silverwater",
                                "Factory cleaning Silverwater",
                                "Warehouse cleaners Silverwater",
                                "Distribution centre cleaning Silverwater",
                                "Warehouse floor cleaning Silverwater",
                                "Industrial sweep and scrub Silverwater",
                                "High pressure cleaning Silverwater",
                                "Workshop cleaning Silverwater",
                                "Manufacturing plant cleaning Silverwater",
                                "Warehouse dusting Silverwater",
                                "Bond warehouse cleaning Silverwater",
                                "End of lease warehouse cleaning Silverwater",
                                "Commercial warehouse cleaning Silverwater",
                                "Heavy duty cleaning Silverwater",
                                "Industrial degreasing Silverwater",
                                "Warehouse sanitisation Silverwater",
                                "Professional warehouse cleaners Silverwater",
                                "Storage facility cleaning Silverwater",
                                "Silverwater industrial cleaners"
                            ].map((keyword, index) => (
