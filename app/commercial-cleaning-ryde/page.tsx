...
export const metadata: Metadata = {
    title: "Commercial Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Ryde. We are the top-rated cleaning company for Commercial Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Ryde",
                                "Commercial cleaners Ryde",
                                "Business cleaning Ryde",
                                "Commercial cleaning company Ryde",
                                "Industrial cleaning Ryde",
                                "Retail cleaning Ryde",
                                "Showroom cleaning Ryde",
                                "Commercial property cleaning Ryde",
                                "Professional commercial cleaners Ryde",
                                "Commercial janitorial services Ryde",
                                "Local commercial cleaners Ryde",
                                "Event cleaning Ryde",
                                "Pub and club cleaning Ryde",
                                "Restaurant cleaning Ryde",
                                "Shopping centre cleaning Ryde",
                                "Commercial sanitisation Ryde",
                                "Office and commercial cleaning Ryde",
                                "Warehouse commercial cleaning Ryde",
                                "Best commercial cleaning Ryde",
                                "Ryde commercial cleaning services"
                            ].map((keyword, index) => (
