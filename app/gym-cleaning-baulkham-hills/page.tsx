...
export const metadata: Metadata = {
    title: "Gym Cleaning Baulkham Hills | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Baulkham Hills. We are the top-rated cleaning company for Gym Cleaning in Baulkham Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Baulkham Hills",
                                "Fitness centre cleaning Baulkham Hills",
                                "Gym cleaners Baulkham Hills",
                                "Yoga studio cleaning Baulkham Hills",
                                "CrossFit gym cleaning Baulkham Hills",
                                "Sports centre cleaning Baulkham Hills",
                                "Gym equipment cleaning Baulkham Hills",
                                "Health club cleaning Baulkham Hills",
                                "Commercial gym cleaning Baulkham Hills",
                                "Professional gym cleaners Baulkham Hills",
                                "Gym sanitisation Baulkham Hills",
                                "Fitness facility cleaning Baulkham Hills",
                                "24/7 gym cleaning Baulkham Hills",
                                "Local gym cleaners Baulkham Hills",
                                "Best gym cleaning company Baulkham Hills",
                                "Martial arts studio cleaning Baulkham Hills",
                                "Pilates studio cleaning Baulkham Hills",
                                "Gym floor cleaning Baulkham Hills",
                                "Gym hygiene services Baulkham Hills",
                                "Baulkham Hills fitness cleaners"
                            ].map((keyword, index) => (
