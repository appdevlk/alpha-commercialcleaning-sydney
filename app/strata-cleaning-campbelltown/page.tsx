...
export const metadata: Metadata = {
    title: "Strata Cleaning Campbelltown | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Campbelltown. We are the top-rated cleaning company for Strata Cleaning in Campbelltown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Campbelltown",
                                "Strata cleaners Campbelltown",
                                "Body corporate cleaning Campbelltown",
                                "Building management cleaning Campbelltown",
                                "Apartment complex cleaning Campbelltown",
                                "Residential building cleaning Campbelltown",
                                "Common area cleaning Campbelltown",
                                "Strata maintenance Campbelltown",
                                "Condominium cleaning Campbelltown",
                                "High rise cleaning Campbelltown",
                                "Stairwell cleaning Campbelltown",
                                "Car park cleaning Campbelltown",
                                "Garbage management Campbelltown",
                                "Strata gardening and cleaning Campbelltown",
                                "Professional strata cleaners Campbelltown",
                                "Reliable strata cleaning Campbelltown",
                                "Strata cleaning rates Campbelltown",
                                "Sydney strata cleaning Campbelltown",
                                "Campbelltown strata services",
                                "Residential strata cleaning Campbelltown"
                            ].map((keyword, index) => (
