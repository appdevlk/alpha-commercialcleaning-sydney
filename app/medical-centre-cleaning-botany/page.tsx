...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Botany | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Botany. We are the top-rated cleaning company for Medical Centre Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Botany",
                                "Healthcare cleaning services Botany",
                                "Medical office cleaning Botany",
                                "Dental clinic cleaning Botany",
                                "Hospital grade cleaning Botany",
                                "Clinical cleaning services Botany",
                                "Medical facility cleaning Botany",
                                "Doctor surgery cleaning Botany",
                                "Professional medical cleaners Botany",
                                "Sanitisation services Botany",
                                "Medical cleaning company Botany",
                                "Allied health cleaning Botany",
                                "Pathology cleaning Botany",
                                "Radiology cleaning services Botany",
                                "Aged care cleaning Botany",
                                "Infection control cleaning Botany",
                                "Medical centre janitors Botany",
                                "Commercial medical cleaning Botany",
                                "Botany medical cleaners",
                                "Sterile cleaning services Botany"
                            ].map((keyword, index) => (
