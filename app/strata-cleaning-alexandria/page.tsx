...
export const metadata: Metadata = {
    title: "Strata Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Alexandria. We are the top-rated cleaning company for Strata Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Alexandria",
                                "Strata cleaners Alexandria",
                                "Body corporate cleaning Alexandria",
                                "Building management cleaning Alexandria",
                                "Apartment complex cleaning Alexandria",
                                "Residential building cleaning Alexandria",
                                "Common area cleaning Alexandria",
                                "Strata maintenance Alexandria",
                                "Condominium cleaning Alexandria",
                                "High rise cleaning Alexandria",
                                "Stairwell cleaning Alexandria",
                                "Car park cleaning Alexandria",
                                "Garbage management Alexandria",
                                "Strata gardening and cleaning Alexandria",
                                "Professional strata cleaners Alexandria",
                                "Reliable strata cleaning Alexandria",
                                "Strata cleaning rates Alexandria",
                                "Sydney strata cleaning Alexandria",
                                "Alexandria strata services",
                                "Residential strata cleaning Alexandria"
                            ].map((keyword, index) => (
