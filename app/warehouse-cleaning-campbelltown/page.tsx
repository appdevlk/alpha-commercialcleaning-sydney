...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Campbelltown | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Campbelltown. We are the top-rated cleaning company for Warehouse Cleaning in Campbelltown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Campbelltown",
                                "Industrial cleaning Campbelltown",
                                "Factory cleaning Campbelltown",
                                "Warehouse cleaners Campbelltown",
                                "Distribution centre cleaning Campbelltown",
                                "Warehouse floor cleaning Campbelltown",
                                "Industrial sweep and scrub Campbelltown",
                                "High pressure cleaning Campbelltown",
                                "Workshop cleaning Campbelltown",
                                "Manufacturing plant cleaning Campbelltown",
                                "Warehouse dusting Campbelltown",
                                "Bond warehouse cleaning Campbelltown",
                                "End of lease warehouse cleaning Campbelltown",
                                "Commercial warehouse cleaning Campbelltown",
                                "Heavy duty cleaning Campbelltown",
                                "Industrial degreasing Campbelltown",
                                "Warehouse sanitisation Campbelltown",
                                "Professional warehouse cleaners Campbelltown",
                                "Storage facility cleaning Campbelltown",
                                "Campbelltown industrial cleaners"
                            ].map((keyword, index) => (
