...
export const metadata: Metadata = {
    title: "Office Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Office Cleaning in Alexandria. We are the top-rated cleaning company for Office Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services Alexandria",
                                "Commercial office cleaning Alexandria",
                                "Corporate cleaning Alexandria",
                                "Office cleaners Alexandria",
                                "Business cleaning services Alexandria",
                                "Professional office cleaners Alexandria",
                                "Daily office cleaning Alexandria",
                                "Office janitorial services Alexandria",
                                "Small office cleaning Alexandria",
                                "Large office cleaning Alexandria",
                                "Executive office cleaning Alexandria",
                                "Office sanitisation Alexandria",
                                "Workspace cleaning Alexandria",
                                "Desk cleaning services Alexandria",
                                "Reliable office cleaners Alexandria",
                                "Affordable office cleaning Alexandria",
                                "Office building cleaning Alexandria",
                                "Tech park cleaning Alexandria",
                                "Strata office cleaning Alexandria",
                                "Alexandria office cleaning company"
                            ].map((keyword, index) => (
