...
export const metadata: Metadata = {
    title: "Childcare Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Childcare Cleaning in Ryde. We are the top-rated cleaning company for Childcare Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Childcare cleaning services Ryde",
                                "Daycare cleaning company Ryde",
                                "Child care centre cleaners Ryde",
                                "Preschool cleaning services Ryde",
                                "Kindergarten cleaning Ryde",
                                "Commercial cleaning for childcare Ryde",
                                "Early learning centre cleaning Ryde",
                                "Professional childcare cleaners Ryde",
                                "Safe childcare cleaning Ryde",
                                "Medical grade childcare cleaning Ryde",
                                "Eco-friendly childcare cleaning Ryde",
                                "Childcare centre janitorial services Ryde",
                                "Local childcare cleaners Ryde",
                                "Best childcare cleaning Ryde",
                                "Childcare facility cleaning Ryde",
                                "Day care centre cleaning Ryde",
                                "Childcare hygiene services Ryde",
                                "School and childcare cleaning Ryde",
                                "Reliable childcare cleaners Ryde",
                                "Ryde childcare cleaning specialists"
                            ].map((keyword, index) => (
