...
export const metadata: Metadata = {
    title: "Gym Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Auburn. We are the top-rated cleaning company for Gym Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Auburn",
                                "Fitness centre cleaning Auburn",
                                "Gym cleaners Auburn",
                                "Yoga studio cleaning Auburn",
                                "CrossFit gym cleaning Auburn",
                                "Sports centre cleaning Auburn",
                                "Gym equipment cleaning Auburn",
                                "Health club cleaning Auburn",
                                "Commercial gym cleaning Auburn",
                                "Professional gym cleaners Auburn",
                                "Gym sanitisation Auburn",
                                "Fitness facility cleaning Auburn",
                                "24/7 gym cleaning Auburn",
                                "Local gym cleaners Auburn",
                                "Best gym cleaning company Auburn",
                                "Martial arts studio cleaning Auburn",
                                "Pilates studio cleaning Auburn",
                                "Gym floor cleaning Auburn",
                                "Gym hygiene services Auburn",
                                "Auburn fitness cleaners"
                            ].map((keyword, index) => (
