...
export const metadata: Metadata = {
    title: "Childcare Cleaning Botany | Professional Cleaning Services",
    description: "Expert Childcare Cleaning in Botany. We are the top-rated cleaning company for Childcare Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Childcare cleaning services Botany",
                                "Daycare cleaning company Botany",
                                "Child care centre cleaners Botany",
                                "Preschool cleaning services Botany",
                                "Kindergarten cleaning Botany",
                                "Commercial cleaning for childcare Botany",
                                "Early learning centre cleaning Botany",
                                "Professional childcare cleaners Botany",
                                "Safe childcare cleaning Botany",
                                "Medical grade childcare cleaning Botany",
                                "Eco-friendly childcare cleaning Botany",
                                "Childcare centre janitorial services Botany",
                                "Local childcare cleaners Botany",
                                "Best childcare cleaning Botany",
                                "Childcare facility cleaning Botany",
                                "Day care centre cleaning Botany",
                                "Childcare hygiene services Botany",
                                "School and childcare cleaning Botany",
                                "Reliable childcare cleaners Botany",
                                "Botany childcare cleaning specialists"
                            ].map((keyword, index) => (
