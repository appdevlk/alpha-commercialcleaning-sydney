...
export const metadata: Metadata = {
    title: "Office Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Office Cleaning in St Marys. We are the top-rated cleaning company for Office Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Office cleaning services St Marys",
                                "Commercial office cleaning St Marys",
                                "Corporate cleaning St Marys",
                                "Office cleaners St Marys",
                                "Business cleaning services St Marys",
                                "Professional office cleaners St Marys",
                                "Daily office cleaning St Marys",
                                "Office janitorial services St Marys",
                                "Small office cleaning St Marys",
                                "Large office cleaning St Marys",
                                "Executive office cleaning St Marys",
                                "Office sanitisation St Marys",
                                "Workspace cleaning St Marys",
                                "Desk cleaning services St Marys",
                                "Reliable office cleaners St Marys",
                                "Affordable office cleaning St Marys",
                                "Office building cleaning St Marys",
                                "Tech park cleaning St Marys",
                                "Strata office cleaning St Marys",
                                "St Marys office cleaning company"
                            ].map((keyword, index) => (
