...
export const metadata: Metadata = {
    title: "Gym Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Cronulla. We are the top-rated cleaning company for Gym Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Cronulla",
                                "Fitness centre cleaning Cronulla",
                                "Gym cleaners Cronulla",
                                "Yoga studio cleaning Cronulla",
                                "CrossFit gym cleaning Cronulla",
                                "Sports centre cleaning Cronulla",
                                "Gym equipment cleaning Cronulla",
                                "Health club cleaning Cronulla",
                                "Commercial gym cleaning Cronulla",
                                "Professional gym cleaners Cronulla",
                                "Gym sanitisation Cronulla",
                                "Fitness facility cleaning Cronulla",
                                "24/7 gym cleaning Cronulla",
                                "Local gym cleaners Cronulla",
                                "Best gym cleaning company Cronulla",
                                "Martial arts studio cleaning Cronulla",
                                "Pilates studio cleaning Cronulla",
                                "Gym floor cleaning Cronulla",
                                "Gym hygiene services Cronulla",
                                "Cronulla fitness cleaners"
                            ].map((keyword, index) => (
