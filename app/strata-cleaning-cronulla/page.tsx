...
export const metadata: Metadata = {
    title: "Strata Cleaning Cronulla | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Cronulla. We are the top-rated cleaning company for Strata Cleaning in Cronulla and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Cronulla",
                                "Strata cleaners Cronulla",
                                "Body corporate cleaning Cronulla",
                                "Building management cleaning Cronulla",
                                "Apartment complex cleaning Cronulla",
                                "Residential building cleaning Cronulla",
                                "Common area cleaning Cronulla",
                                "Strata maintenance Cronulla",
                                "Condominium cleaning Cronulla",
                                "High rise cleaning Cronulla",
                                "Stairwell cleaning Cronulla",
                                "Car park cleaning Cronulla",
                                "Garbage management Cronulla",
                                "Strata gardening and cleaning Cronulla",
                                "Professional strata cleaners Cronulla",
                                "Reliable strata cleaning Cronulla",
                                "Strata cleaning rates Cronulla",
                                "Sydney strata cleaning Cronulla",
                                "Cronulla strata services",
                                "Residential strata cleaning Cronulla"
                            ].map((keyword, index) => (
