...
export const metadata: Metadata = {
    title: "Strata Cleaning Seven Hills | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Seven Hills. We are the top-rated cleaning company for Strata Cleaning in Seven Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Seven Hills",
                                "Strata cleaners Seven Hills",
                                "Body corporate cleaning Seven Hills",
                                "Building management cleaning Seven Hills",
                                "Apartment complex cleaning Seven Hills",
                                "Residential building cleaning Seven Hills",
                                "Common area cleaning Seven Hills",
                                "Strata maintenance Seven Hills",
                                "Condominium cleaning Seven Hills",
                                "High rise cleaning Seven Hills",
                                "Stairwell cleaning Seven Hills",
                                "Car park cleaning Seven Hills",
                                "Garbage management Seven Hills",
                                "Strata gardening and cleaning Seven Hills",
                                "Professional strata cleaners Seven Hills",
                                "Reliable strata cleaning Seven Hills",
                                "Strata cleaning rates Seven Hills",
                                "Sydney strata cleaning Seven Hills",
                                "Seven Hills strata services",
                                "Residential strata cleaning Seven Hills"
                            ].map((keyword, index) => (
