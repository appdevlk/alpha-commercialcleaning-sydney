...
export const metadata: Metadata = {
    title: "Gym Cleaning Parramatta | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Parramatta. We are the top-rated cleaning company for Gym Cleaning in Parramatta and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Gym cleaners Parramatta",
                                "Yoga studio cleaning Parramatta",
                                "CrossFit gym cleaning Parramatta",
                                "Sports centre cleaning Parramatta",
                                "Gym equipment cleaning Parramatta",
                                "Health club cleaning Parramatta",
                                "Commercial gym cleaning Parramatta",
                                "Professional gym cleaners Parramatta",
                                "Gym sanitisation Parramatta",
                                "Fitness facility cleaning Parramatta",
                                "24/7 gym cleaning Parramatta",
                                "Local gym cleaners Parramatta",
                                "Best gym cleaning company Parramatta",
                                "Martial arts studio cleaning Parramatta",
                                "Pilates studio cleaning Parramatta",
                                "Gym floor cleaning Parramatta",
                                "Gym hygiene services Parramatta",
                                "Parramatta fitness cleaners"
                            ].map((keyword, index) => (
