...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Blacktown | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Blacktown. We are the top-rated cleaning company for Warehouse Cleaning in Blacktown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Blacktown",
                                "Industrial cleaning Blacktown",
                                "Factory cleaning Blacktown",
                                "Warehouse cleaners Blacktown",
                                "Distribution centre cleaning Blacktown",
                                "Warehouse floor cleaning Blacktown",
                                "Industrial sweep and scrub Blacktown",
                                "High pressure cleaning Blacktown",
                                "Workshop cleaning Blacktown",
                                "Manufacturing plant cleaning Blacktown",
                                "Warehouse dusting Blacktown",
                                "Bond warehouse cleaning Blacktown",
                                "End of lease warehouse cleaning Blacktown",
                                "Commercial warehouse cleaning Blacktown",
                                "Heavy duty cleaning Blacktown",
                                "Industrial degreasing Blacktown",
                                "Warehouse sanitisation Blacktown",
                                "Professional warehouse cleaners Blacktown",
                                "Storage facility cleaning Blacktown",
                                "Blacktown industrial cleaners"
                            ].map((keyword, index) => (
