...
export const metadata: Metadata = {
    title: "Gym Cleaning Chatswood | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Chatswood. We are the top-rated cleaning company for Gym Cleaning in Chatswood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Chatswood",
                                "Fitness centre cleaning Chatswood",
                                "Gym cleaners Chatswood",
                                "Yoga studio cleaning Chatswood",
                                "CrossFit gym cleaning Chatswood",
                                "Sports centre cleaning Chatswood",
                                "Gym equipment cleaning Chatswood",
                                "Health club cleaning Chatswood",
                                "Commercial gym cleaning Chatswood",
                                "Professional gym cleaners Chatswood",
                                "Gym sanitisation Chatswood",
                                "Fitness facility cleaning Chatswood",
                                "24/7 gym cleaning Chatswood",
                                "Local gym cleaners Chatswood",
                                "Best gym cleaning company Chatswood",
                                "Martial arts studio cleaning Chatswood",
                                "Pilates studio cleaning Chatswood",
                                "Gym floor cleaning Chatswood",
                                "Gym hygiene services Chatswood",
                                "Chatswood fitness cleaners"
                            ].map((keyword, index) => (
