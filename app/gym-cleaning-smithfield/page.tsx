...
export const metadata: Metadata = {
    title: "Gym Cleaning Smithfield | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Smithfield. We are the top-rated cleaning company for Gym Cleaning in Smithfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Smithfield",
                                "Fitness centre cleaning Smithfield",
                                "Gym cleaners Smithfield",
                                "Yoga studio cleaning Smithfield",
                                "CrossFit gym cleaning Smithfield",
                                "Sports centre cleaning Smithfield",
                                "Gym equipment cleaning Smithfield",
                                "Health club cleaning Smithfield",
                                "Commercial gym cleaning Smithfield",
                                "Professional gym cleaners Smithfield",
                                "Gym sanitisation Smithfield",
                                "Fitness facility cleaning Smithfield",
                                "24/7 gym cleaning Smithfield",
                                "Local gym cleaners Smithfield",
                                "Best gym cleaning company Smithfield",
                                "Martial arts studio cleaning Smithfield",
                                "Pilates studio cleaning Smithfield",
                                "Gym floor cleaning Smithfield",
                                "Gym hygiene services Smithfield",
                                "Smithfield fitness cleaners"
                            ].map((keyword, index) => (
