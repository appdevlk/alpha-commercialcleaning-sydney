...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Hurstville | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Hurstville. We are the top-rated cleaning company for Warehouse Cleaning in Hurstville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Hurstville",
                                "Industrial cleaning Hurstville",
                                "Factory cleaning Hurstville",
                                "Warehouse cleaners Hurstville",
                                "Distribution centre cleaning Hurstville",
                                "Warehouse floor cleaning Hurstville",
                                "Industrial sweep and scrub Hurstville",
                                "High pressure cleaning Hurstville",
                                "Workshop cleaning Hurstville",
                                "Manufacturing plant cleaning Hurstville",
                                "Warehouse dusting Hurstville",
                                "Bond warehouse cleaning Hurstville",
                                "End of lease warehouse cleaning Hurstville",
                                "Commercial warehouse cleaning Hurstville",
                                "Heavy duty cleaning Hurstville",
                                "Industrial degreasing Hurstville",
                                "Warehouse sanitisation Hurstville",
                                "Professional warehouse cleaners Hurstville",
                                "Storage facility cleaning Hurstville",
                                "Hurstville industrial cleaners"
                            ].map((keyword, index) => (
