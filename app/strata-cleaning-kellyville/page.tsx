...
export const metadata: Metadata = {
    title: "Strata Cleaning Kellyville | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Kellyville. We are the top-rated cleaning company for Strata Cleaning in Kellyville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Kellyville",
                                "Strata cleaners Kellyville",
                                "Body corporate cleaning Kellyville",
                                "Building management cleaning Kellyville",
                                "Apartment complex cleaning Kellyville",
                                "Residential building cleaning Kellyville",
                                "Common area cleaning Kellyville",
                                "Strata maintenance Kellyville",
                                "Condominium cleaning Kellyville",
                                "High rise cleaning Kellyville",
                                "Stairwell cleaning Kellyville",
                                "Car park cleaning Kellyville",
                                "Garbage management Kellyville",
                                "Strata gardening and cleaning Kellyville",
                                "Professional strata cleaners Kellyville",
                                "Reliable strata cleaning Kellyville",
                                "Strata cleaning rates Kellyville",
                                "Sydney strata cleaning Kellyville",
                                "Kellyville strata services",
                                "Residential strata cleaning Kellyville"
                            ].map((keyword, index) => (
