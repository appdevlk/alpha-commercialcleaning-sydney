...
export const metadata: Metadata = {
    title: "Strata Cleaning Smithfield | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Smithfield. We are the top-rated cleaning company for Strata Cleaning in Smithfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Smithfield",
                                "Strata cleaners Smithfield",
                                "Body corporate cleaning Smithfield",
                                "Building management cleaning Smithfield",
                                "Apartment complex cleaning Smithfield",
                                "Residential building cleaning Smithfield",
                                "Common area cleaning Smithfield",
                                "Strata maintenance Smithfield",
                                "Condominium cleaning Smithfield",
                                "High rise cleaning Smithfield",
                                "Stairwell cleaning Smithfield",
                                "Car park cleaning Smithfield",
                                "Garbage management Smithfield",
                                "Strata gardening and cleaning Smithfield",
                                "Professional strata cleaners Smithfield",
                                "Reliable strata cleaning Smithfield",
                                "Strata cleaning rates Smithfield",
                                "Sydney strata cleaning Smithfield",
                                "Smithfield strata services",
                                "Residential strata cleaning Smithfield"
                            ].map((keyword, index) => (
