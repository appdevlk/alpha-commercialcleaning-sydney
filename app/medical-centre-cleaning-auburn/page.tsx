...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Auburn. We are the top-rated cleaning company for Medical Centre Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Auburn",
                                "Medical office cleaning Auburn",
                                "Dental clinic cleaning Auburn",
                                "Hospital grade cleaning Auburn",
                                "Clinical cleaning services Auburn",
                                "Medical facility cleaning Auburn",
                                "Doctor surgery cleaning Auburn",
                                "Professional medical cleaners Auburn",
                                "Sanitisation services Auburn",
                                "Medical cleaning company Auburn",
                                "Allied health cleaning Auburn",
                                "Pathology cleaning Auburn",
                                "Radiology cleaning services Auburn",
                                "Aged care cleaning Auburn",
                                "Infection control cleaning Auburn",
                                "Medical centre janitors Auburn",
                                "Commercial medical cleaning Auburn",
                                "Auburn medical cleaners",
                                "Sterile cleaning services Auburn"
                            ].map((keyword, index) => (
