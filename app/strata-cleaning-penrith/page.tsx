...
export const metadata: Metadata = {
    title: "Strata Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Penrith. We are the top-rated cleaning company for Strata Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Penrith",
                                "Strata cleaners Penrith",
                                "Body corporate cleaning Penrith",
                                "Building management cleaning Penrith",
                                "Apartment complex cleaning Penrith",
                                "Residential building cleaning Penrith",
                                "Common area cleaning Penrith",
                                "Strata maintenance Penrith",
                                "Condominium cleaning Penrith",
                                "High rise cleaning Penrith",
                                "Stairwell cleaning Penrith",
                                "Car park cleaning Penrith",
                                "Garbage management Penrith",
                                "Strata gardening and cleaning Penrith",
                                "Professional strata cleaners Penrith",
                                "Reliable strata cleaning Penrith",
                                "Strata cleaning rates Penrith",
                                "Sydney strata cleaning Penrith",
                                "Penrith strata services",
                                "Residential strata cleaning Penrith"
                            ].map((keyword, index) => (
