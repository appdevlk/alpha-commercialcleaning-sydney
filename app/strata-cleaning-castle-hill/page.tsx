...
export const metadata: Metadata = {
    title: "Strata Cleaning Castle Hill | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Castle Hill. We are the top-rated cleaning company for Strata Cleaning in Castle Hill and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Castle Hill",
                                "Strata cleaners Castle Hill",
                                "Body corporate cleaning Castle Hill",
                                "Building management cleaning Castle Hill",
                                "Apartment complex cleaning Castle Hill",
                                "Residential building cleaning Castle Hill",
                                "Common area cleaning Castle Hill",
                                "Strata maintenance Castle Hill",
                                "Condominium cleaning Castle Hill",
                                "High rise cleaning Castle Hill",
                                "Stairwell cleaning Castle Hill",
                                "Car park cleaning Castle Hill",
                                "Garbage management Castle Hill",
                                "Strata gardening and cleaning Castle Hill",
                                "Professional strata cleaners Castle Hill",
                                "Reliable strata cleaning Castle Hill",
                                "Strata cleaning rates Castle Hill",
                                "Sydney strata cleaning Castle Hill",
                                "Castle Hill strata services",
                                "Residential strata cleaning Castle Hill"
                            ].map((keyword, index) => (
