...
export const metadata: Metadata = {
    title: "Commercial Cleaning Botany | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Botany. We are the top-rated cleaning company for Commercial Cleaning in Botany and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Botany",
                                "Commercial cleaners Botany",
                                "Business cleaning Botany",
                                "Commercial cleaning company Botany",
                                "Industrial cleaning Botany",
                                "Retail cleaning Botany",
                                "Showroom cleaning Botany",
                                "Commercial property cleaning Botany",
                                "Professional commercial cleaners Botany",
                                "Commercial janitorial services Botany",
                                "Local commercial cleaners Botany",
                                "Event cleaning Botany",
                                "Pub and club cleaning Botany",
                                "Restaurant cleaning Botany",
                                "Shopping centre cleaning Botany",
                                "Commercial sanitisation Botany",
                                "Office and commercial cleaning Botany",
                                "Warehouse commercial cleaning Botany",
                                "Best commercial cleaning Botany",
                                "Botany commercial cleaning services"
                            ].map((keyword, index) => (
