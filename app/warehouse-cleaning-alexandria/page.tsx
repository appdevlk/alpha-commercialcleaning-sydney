...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Alexandria. We are the top-rated cleaning company for Warehouse Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Alexandria",
                                "Industrial cleaning Alexandria",
                                "Factory cleaning Alexandria",
                                "Warehouse cleaners Alexandria",
                                "Distribution centre cleaning Alexandria",
                                "Warehouse floor cleaning Alexandria",
                                "Industrial sweep and scrub Alexandria",
                                "High pressure cleaning Alexandria",
                                "Workshop cleaning Alexandria",
                                "Manufacturing plant cleaning Alexandria",
                                "Warehouse dusting Alexandria",
                                "Bond warehouse cleaning Alexandria",
                                "End of lease warehouse cleaning Alexandria",
                                "Commercial warehouse cleaning Alexandria",
                                "Heavy duty cleaning Alexandria",
                                "Industrial degreasing Alexandria",
                                "Warehouse sanitisation Alexandria",
                                "Professional warehouse cleaners Alexandria",
                                "Storage facility cleaning Alexandria",
                                "Alexandria industrial cleaners"
                            ].map((keyword, index) => (
