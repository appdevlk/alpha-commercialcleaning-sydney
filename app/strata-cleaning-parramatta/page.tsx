...
export const metadata: Metadata = {
    title: "Strata Cleaning Parramatta | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Parramatta. We are the top-rated cleaning company for Strata Cleaning in Parramatta and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Parramatta",
                                "Strata cleaners Parramatta",
                                "Body corporate cleaning Parramatta",
                                "Building management cleaning Parramatta",
                                "Apartment complex cleaning Parramatta",
                                "Residential building cleaning Parramatta",
                                "Common area cleaning Parramatta",
                                "Strata maintenance Parramatta",
                                "Condominium cleaning Parramatta",
                                "High rise cleaning Parramatta",
                                "Stairwell cleaning Parramatta",
                                "Car park cleaning Parramatta",
                                "Garbage management Parramatta",
                                "Strata gardening and cleaning Parramatta",
                                "Professional strata cleaners Parramatta",
                                "Reliable strata cleaning Parramatta",
                                "Strata cleaning rates Parramatta",
                                "Sydney strata cleaning Parramatta",
                                "Parramatta strata services",
                                "Residential strata cleaning Parramatta"
                            ].map((keyword, index) => (
