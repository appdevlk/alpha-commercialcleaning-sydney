...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Strathfield | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Strathfield. We are the top-rated cleaning company for Warehouse Cleaning in Strathfield and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Strathfield",
                                "Industrial cleaning Strathfield",
                                "Factory cleaning Strathfield",
                                "Warehouse cleaners Strathfield",
                                "Distribution centre cleaning Strathfield",
                                "Warehouse floor cleaning Strathfield",
                                "Industrial sweep and scrub Strathfield",
                                "High pressure cleaning Strathfield",
                                "Workshop cleaning Strathfield",
                                "Manufacturing plant cleaning Strathfield",
                                "Warehouse dusting Strathfield",
                                "Bond warehouse cleaning Strathfield",
                                "End of lease warehouse cleaning Strathfield",
                                "Commercial warehouse cleaning Strathfield",
                                "Heavy duty cleaning Strathfield",
                                "Industrial degreasing Strathfield",
                                "Warehouse sanitisation Strathfield",
                                "Professional warehouse cleaners Strathfield",
                                "Storage facility cleaning Strathfield",
                                "Strathfield industrial cleaners"
                            ].map((keyword, index) => (
