...
export const metadata: Metadata = {
    title: "Gym Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Bankstown. We are the top-rated cleaning company for Gym Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Bankstown",
                                "Fitness centre cleaning Bankstown",
                                "Gym cleaners Bankstown",
                                "Yoga studio cleaning Bankstown",
                                "CrossFit gym cleaning Bankstown",
                                "Sports centre cleaning Bankstown",
                                "Gym equipment cleaning Bankstown",
                                "Health club cleaning Bankstown",
                                "Commercial gym cleaning Bankstown",
                                "Professional gym cleaners Bankstown",
                                "Gym sanitisation Bankstown",
                                "Fitness facility cleaning Bankstown",
                                "24/7 gym cleaning Bankstown",
                                "Local gym cleaners Bankstown",
                                "Best gym cleaning company Bankstown",
                                "Martial arts studio cleaning Bankstown",
                                "Pilates studio cleaning Bankstown",
                                "Gym floor cleaning Bankstown",
                                "Gym hygiene services Bankstown",
                                "Bankstown fitness cleaners"
                            ].map((keyword, index) => (
