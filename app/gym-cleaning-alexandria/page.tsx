...
export const metadata: Metadata = {
    title: "Gym Cleaning Alexandria | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Alexandria. We are the top-rated cleaning company for Gym Cleaning in Alexandria and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Alexandria",
                                "Fitness centre cleaning Alexandria",
                                "Gym cleaners Alexandria",
                                "Yoga studio cleaning Alexandria",
                                "CrossFit gym cleaning Alexandria",
                                "Sports centre cleaning Alexandria",
                                "Gym equipment cleaning Alexandria",
                                "Health club cleaning Alexandria",
                                "Commercial gym cleaning Alexandria",
                                "Professional gym cleaners Alexandria",
                                "Gym sanitisation Alexandria",
                                "Fitness facility cleaning Alexandria",
                                "24/7 gym cleaning Alexandria",
                                "Local gym cleaners Alexandria",
                                "Best gym cleaning company Alexandria",
                                "Martial arts studio cleaning Alexandria",
                                "Pilates studio cleaning Alexandria",
                                "Gym floor cleaning Alexandria",
                                "Gym hygiene services Alexandria",
                                "Alexandria fitness cleaners"
                            ].map((keyword, index) => (
