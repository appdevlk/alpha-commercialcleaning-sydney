...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Parramatta | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Parramatta. We are the top-rated cleaning company for Medical Centre Cleaning in Parramatta and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "Healthcare cleaning services Parramatta",
                                "Medical office cleaning Parramatta",
                                "Dental clinic cleaning Parramatta",
                                "Hospital grade cleaning Parramatta",
                                "Clinical cleaning services Parramatta",
                                "Medical facility cleaning Parramatta",
                                "Doctor surgery cleaning Parramatta",
                                "Professional medical cleaners Parramatta",
                                "Sanitisation services Parramatta",
                                "Medical cleaning company Parramatta",
                                "Allied health cleaning Parramatta",
                                "Pathology cleaning Parramatta",
                                "Radiology cleaning services Parramatta",
                                "Aged care cleaning Parramatta",
                                "Infection control cleaning Parramatta",
                                "Medical centre janitors Parramatta",
                                "Commercial medical cleaning Parramatta",
                                "Parramatta medical cleaners",
                                "Sterile cleaning services Parramatta"
                            ].map((keyword, index) => (
