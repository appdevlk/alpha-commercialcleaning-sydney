...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Surry Hills | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Surry Hills. We are the top-rated cleaning company for Warehouse Cleaning in Surry Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Surry Hills",
                                "Industrial cleaning Surry Hills",
                                "Factory cleaning Surry Hills",
                                "Warehouse cleaners Surry Hills",
                                "Distribution centre cleaning Surry Hills",
                                "Warehouse floor cleaning Surry Hills",
                                "Industrial sweep and scrub Surry Hills",
                                "High pressure cleaning Surry Hills",
                                "Workshop cleaning Surry Hills",
                                "Manufacturing plant cleaning Surry Hills",
                                "Warehouse dusting Surry Hills",
                                "Bond warehouse cleaning Surry Hills",
                                "End of lease warehouse cleaning Surry Hills",
                                "Commercial warehouse cleaning Surry Hills",
                                "Heavy duty cleaning Surry Hills",
                                "Industrial degreasing Surry Hills",
                                "Warehouse sanitisation Surry Hills",
                                "Professional warehouse cleaners Surry Hills",
                                "Storage facility cleaning Surry Hills",
                                "Surry Hills industrial cleaners"
                            ].map((keyword, index) => (
