...
export const metadata: Metadata = {
    title: "Gym Cleaning North Sydney | Professional Cleaning Services",
    description: "Expert Gym Cleaning in North Sydney. We are the top-rated cleaning company for Gym Cleaning in North Sydney and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services North Sydney",
                                "Fitness centre cleaning North Sydney",
                                "Gym cleaners North Sydney",
                                "Yoga studio cleaning North Sydney",
                                "CrossFit gym cleaning North Sydney",
                                "Sports centre cleaning North Sydney",
                                "Gym equipment cleaning North Sydney",
                                "Health club cleaning North Sydney",
                                "Commercial gym cleaning North Sydney",
                                "Professional gym cleaners North Sydney",
                                "Gym sanitisation North Sydney",
                                "Fitness facility cleaning North Sydney",
                                "24/7 gym cleaning North Sydney",
                                "Local gym cleaners North Sydney",
                                "Best gym cleaning company North Sydney",
                                "Martial arts studio cleaning North Sydney",
                                "Pilates studio cleaning North Sydney",
                                "Gym floor cleaning North Sydney",
                                "Gym hygiene services North Sydney",
                                "North Sydney fitness cleaners"
                            ].map((keyword, index) => (
