...
export const metadata: Metadata = {
    title: "Commercial Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Commercial Cleaning in Randwick. We are the top-rated cleaning company for Commercial Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Commercial cleaning services Randwick",
                                "Commercial cleaners Randwick",
                                "Business cleaning Randwick",
                                "Commercial cleaning company Randwick",
                                "Industrial cleaning Randwick",
                                "Retail cleaning Randwick",
                                "Showroom cleaning Randwick",
                                "Commercial property cleaning Randwick",
                                "Professional commercial cleaners Randwick",
                                "Commercial janitorial services Randwick",
                                "Local commercial cleaners Randwick",
                                "Event cleaning Randwick",
                                "Pub and club cleaning Randwick",
                                "Restaurant cleaning Randwick",
                                "Shopping centre cleaning Randwick",
                                "Commercial sanitisation Randwick",
                                "Office and commercial cleaning Randwick",
                                "Warehouse commercial cleaning Randwick",
                                "Best commercial cleaning Randwick",
                                "Randwick commercial cleaning services"
                            ].map((keyword, index) => (
