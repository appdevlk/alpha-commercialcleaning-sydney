...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Wetherill Park | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Wetherill Park. We are the top-rated cleaning company for Warehouse Cleaning in Wetherill Park and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Wetherill Park",
                                "Industrial cleaning Wetherill Park",
                                "Factory cleaning Wetherill Park",
                                "Warehouse cleaners Wetherill Park",
                                "Distribution centre cleaning Wetherill Park",
                                "Warehouse floor cleaning Wetherill Park",
                                "Industrial sweep and scrub Wetherill Park",
                                "High pressure cleaning Wetherill Park",
                                "Workshop cleaning Wetherill Park",
                                "Manufacturing plant cleaning Wetherill Park",
                                "Warehouse dusting Wetherill Park",
                                "Bond warehouse cleaning Wetherill Park",
                                "End of lease warehouse cleaning Wetherill Park",
                                "Commercial warehouse cleaning Wetherill Park",
                                "Heavy duty cleaning Wetherill Park",
                                "Industrial degreasing Wetherill Park",
                                "Warehouse sanitisation Wetherill Park",
                                "Professional warehouse cleaners Wetherill Park",
                                "Storage facility cleaning Wetherill Park",
                                "Wetherill Park industrial cleaners"
                            ].map((keyword, index) => (
