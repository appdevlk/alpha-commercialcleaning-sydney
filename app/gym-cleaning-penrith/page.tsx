...
export const metadata: Metadata = {
    title: "Gym Cleaning Penrith | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Penrith. We are the top-rated cleaning company for Gym Cleaning in Penrith and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Penrith",
                                "Fitness centre cleaning Penrith",
                                "Gym cleaners Penrith",
                                "Yoga studio cleaning Penrith",
                                "CrossFit gym cleaning Penrith",
                                "Sports centre cleaning Penrith",
                                "Gym equipment cleaning Penrith",
                                "Health club cleaning Penrith",
                                "Commercial gym cleaning Penrith",
                                "Professional gym cleaners Penrith",
                                "Gym sanitisation Penrith",
                                "Fitness facility cleaning Penrith",
                                "24/7 gym cleaning Penrith",
                                "Local gym cleaners Penrith",
                                "Best gym cleaning company Penrith",
                                "Martial arts studio cleaning Penrith",
                                "Pilates studio cleaning Penrith",
                                "Gym floor cleaning Penrith",
                                "Gym hygiene services Penrith",
                                "Penrith fitness cleaners"
                            ].map((keyword, index) => (
