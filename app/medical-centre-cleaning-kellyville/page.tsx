...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Kellyville | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Kellyville. We are the top-rated cleaning company for Medical Centre Cleaning in Kellyville and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Kellyville",
                                "Healthcare cleaning services Kellyville",
                                "Medical office cleaning Kellyville",
                                "Dental clinic cleaning Kellyville",
                                "Hospital grade cleaning Kellyville",
                                "Clinical cleaning services Kellyville",
                                "Medical facility cleaning Kellyville",
                                "Doctor surgery cleaning Kellyville",
                                "Professional medical cleaners Kellyville",
                                "Sanitisation services Kellyville",
                                "Medical cleaning company Kellyville",
                                "Allied health cleaning Kellyville",
                                "Pathology cleaning Kellyville",
                                "Radiology cleaning services Kellyville",
                                "Aged care cleaning Kellyville",
                                "Infection control cleaning Kellyville",
                                "Medical centre janitors Kellyville",
                                "Commercial medical cleaning Kellyville",
                                "Kellyville medical cleaners",
                                "Sterile cleaning services Kellyville"
                            ].map((keyword, index) => (
