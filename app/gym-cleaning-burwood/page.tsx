...
export const metadata: Metadata = {
    title: "Gym Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Burwood. We are the top-rated cleaning company for Gym Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Burwood",
                                "Fitness centre cleaning Burwood",
                                "Gym cleaners Burwood",
                                "Yoga studio cleaning Burwood",
                                "CrossFit gym cleaning Burwood",
                                "Sports centre cleaning Burwood",
                                "Gym equipment cleaning Burwood",
                                "Health club cleaning Burwood",
                                "Commercial gym cleaning Burwood",
                                "Professional gym cleaners Burwood",
                                "Gym sanitisation Burwood",
                                "Fitness facility cleaning Burwood",
                                "24/7 gym cleaning Burwood",
                                "Local gym cleaners Burwood",
                                "Best gym cleaning company Burwood",
                                "Martial arts studio cleaning Burwood",
                                "Pilates studio cleaning Burwood",
                                "Gym floor cleaning Burwood",
                                "Gym hygiene services Burwood",
                                "Burwood fitness cleaners"
                            ].map((keyword, index) => (
