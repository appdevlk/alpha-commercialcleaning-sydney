...
export const metadata: Metadata = {
    title: "Strata Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Ryde. We are the top-rated cleaning company for Strata Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Ryde",
                                "Strata cleaners Ryde",
                                "Body corporate cleaning Ryde",
                                "Building management cleaning Ryde",
                                "Apartment complex cleaning Ryde",
                                "Residential building cleaning Ryde",
                                "Common area cleaning Ryde",
                                "Strata maintenance Ryde",
                                "Condominium cleaning Ryde",
                                "High rise cleaning Ryde",
                                "Stairwell cleaning Ryde",
                                "Car park cleaning Ryde",
                                "Garbage management Ryde",
                                "Strata gardening and cleaning Ryde",
                                "Professional strata cleaners Ryde",
                                "Reliable strata cleaning Ryde",
                                "Strata cleaning rates Ryde",
                                "Sydney strata cleaning Ryde",
                                "Ryde strata services",
                                "Residential strata cleaning Ryde"
                            ].map((keyword, index) => (
