...
export const metadata: Metadata = {
    title: "Gym Cleaning Ryde | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Ryde. We are the top-rated cleaning company for Gym Cleaning in Ryde and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Ryde",
                                "Fitness centre cleaning Ryde",
                                "Gym cleaners Ryde",
                                "Yoga studio cleaning Ryde",
                                "CrossFit gym cleaning Ryde",
                                "Sports centre cleaning Ryde",
                                "Gym equipment cleaning Ryde",
                                "Health club cleaning Ryde",
                                "Commercial gym cleaning Ryde",
                                "Professional gym cleaners Ryde",
                                "Gym sanitisation Ryde",
                                "Fitness facility cleaning Ryde",
                                "24/7 gym cleaning Ryde",
                                "Local gym cleaners Ryde",
                                "Best gym cleaning company Ryde",
                                "Martial arts studio cleaning Ryde",
                                "Pilates studio cleaning Ryde",
                                "Gym floor cleaning Ryde",
                                "Gym hygiene services Ryde",
                                "Ryde fitness cleaners"
                            ].map((keyword, index) => (
