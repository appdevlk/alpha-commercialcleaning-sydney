...
export const metadata: Metadata = {
    title: "Gym Cleaning Castle Hill | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Castle Hill. We are the top-rated cleaning company for Gym Cleaning in Castle Hill and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Castle Hill",
                                "Fitness centre cleaning Castle Hill",
                                "Gym cleaners Castle Hill",
                                "Yoga studio cleaning Castle Hill",
                                "CrossFit gym cleaning Castle Hill",
                                "Sports centre cleaning Castle Hill",
                                "Gym equipment cleaning Castle Hill",
                                "Health club cleaning Castle Hill",
                                "Commercial gym cleaning Castle Hill",
                                "Professional gym cleaners Castle Hill",
                                "Gym sanitisation Castle Hill",
                                "Fitness facility cleaning Castle Hill",
                                "24/7 gym cleaning Castle Hill",
                                "Local gym cleaners Castle Hill",
                                "Best gym cleaning company Castle Hill",
                                "Martial arts studio cleaning Castle Hill",
                                "Pilates studio cleaning Castle Hill",
                                "Gym floor cleaning Castle Hill",
                                "Gym hygiene services Castle Hill",
                                "Castle Hill fitness cleaners"
                            ].map((keyword, index) => (
