...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Baulkham Hills | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Baulkham Hills. We are the top-rated cleaning company for Warehouse Cleaning in Baulkham Hills and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Baulkham Hills",
                                "Industrial cleaning Baulkham Hills",
                                "Factory cleaning Baulkham Hills",
                                "Warehouse cleaners Baulkham Hills",
                                "Distribution centre cleaning Baulkham Hills",
                                "Warehouse floor cleaning Baulkham Hills",
                                "Industrial sweep and scrub Baulkham Hills",
                                "High pressure cleaning Baulkham Hills",
                                "Workshop cleaning Baulkham Hills",
                                "Manufacturing plant cleaning Baulkham Hills",
                                "Warehouse dusting Baulkham Hills",
                                "Bond warehouse cleaning Baulkham Hills",
                                "End of lease warehouse cleaning Baulkham Hills",
                                "Commercial warehouse cleaning Baulkham Hills",
                                "Heavy duty cleaning Baulkham Hills",
                                "Industrial degreasing Baulkham Hills",
                                "Warehouse sanitisation Baulkham Hills",
                                "Professional warehouse cleaners Baulkham Hills",
                                "Storage facility cleaning Baulkham Hills",
                                "Baulkham Hills industrial cleaners"
                            ].map((keyword, index) => (
