...
export const metadata: Metadata = {
    title: "Strata Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Bankstown. We are the top-rated cleaning company for Strata Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Bankstown",
                                "Strata cleaners Bankstown",
                                "Body corporate cleaning Bankstown",
                                "Building management cleaning Bankstown",
                                "Apartment complex cleaning Bankstown",
                                "Residential building cleaning Bankstown",
                                "Common area cleaning Bankstown",
                                "Strata maintenance Bankstown",
                                "Condominium cleaning Bankstown",
                                "High rise cleaning Bankstown",
                                "Stairwell cleaning Bankstown",
                                "Car park cleaning Bankstown",
                                "Garbage management Bankstown",
                                "Strata gardening and cleaning Bankstown",
                                "Professional strata cleaners Bankstown",
                                "Reliable strata cleaning Bankstown",
                                "Strata cleaning rates Bankstown",
                                "Sydney strata cleaning Bankstown",
                                "Bankstown strata services",
                                "Residential strata cleaning Bankstown"
                            ].map((keyword, index) => (
