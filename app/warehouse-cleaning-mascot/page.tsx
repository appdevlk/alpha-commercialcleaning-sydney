...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Mascot | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Mascot. We are the top-rated cleaning company for Warehouse Cleaning in Mascot and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Mascot",
                                "Industrial cleaning Mascot",
                                "Factory cleaning Mascot",
                                "Warehouse cleaners Mascot",
                                "Distribution centre cleaning Mascot",
                                "Warehouse floor cleaning Mascot",
                                "Industrial sweep and scrub Mascot",
                                "High pressure cleaning Mascot",
                                "Workshop cleaning Mascot",
                                "Manufacturing plant cleaning Mascot",
                                "Warehouse dusting Mascot",
                                "Bond warehouse cleaning Mascot",
                                "End of lease warehouse cleaning Mascot",
                                "Commercial warehouse cleaning Mascot",
                                "Heavy duty cleaning Mascot",
                                "Industrial degreasing Mascot",
                                "Warehouse sanitisation Mascot",
                                "Professional warehouse cleaners Mascot",
                                "Storage facility cleaning Mascot",
                                "Mascot industrial cleaners"
                            ].map((keyword, index) => (
