...
export const metadata: Metadata = {
    title: "Childcare Cleaning Burwood | Professional Cleaning Services",
    description: "Expert Childcare Cleaning in Burwood. We are the top-rated cleaning company for Childcare Cleaning in Burwood and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Childcare cleaning services Burwood",
                                "Daycare cleaning company Burwood",
                                "Child care centre cleaners Burwood",
                                "Preschool cleaning services Burwood",
                                "Kindergarten cleaning Burwood",
                                "Commercial cleaning for childcare Burwood",
                                "Early learning centre cleaning Burwood",
                                "Professional childcare cleaners Burwood",
                                "Safe childcare cleaning Burwood",
                                "Medical grade childcare cleaning Burwood",
                                "Eco-friendly childcare cleaning Burwood",
                                "Childcare centre janitorial services Burwood",
                                "Local childcare cleaners Burwood",
                                "Best childcare cleaning Burwood",
                                "Childcare facility cleaning Burwood",
                                "Day care centre cleaning Burwood",
                                "Childcare hygiene services Burwood",
                                "School and childcare cleaning Burwood",
                                "Reliable childcare cleaners Burwood",
                                "Burwood childcare cleaning specialists"
                            ].map((keyword, index) => (
