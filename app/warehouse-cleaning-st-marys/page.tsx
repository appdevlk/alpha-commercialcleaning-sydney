...
export const metadata: Metadata = {
    title: "Warehouse Cleaning St Marys | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in St Marys. We are the top-rated cleaning company for Warehouse Cleaning in St Marys and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services St Marys",
                                "Industrial cleaning St Marys",
                                "Factory cleaning St Marys",
                                "Warehouse cleaners St Marys",
                                "Distribution centre cleaning St Marys",
                                "Warehouse floor cleaning St Marys",
                                "Industrial sweep and scrub St Marys",
                                "High pressure cleaning St Marys",
                                "Workshop cleaning St Marys",
                                "Manufacturing plant cleaning St Marys",
                                "Warehouse dusting St Marys",
                                "Bond warehouse cleaning St Marys",
                                "End of lease warehouse cleaning St Marys",
                                "Commercial warehouse cleaning St Marys",
                                "Heavy duty cleaning St Marys",
                                "Industrial degreasing St Marys",
                                "Warehouse sanitisation St Marys",
                                "Professional warehouse cleaners St Marys",
                                "Storage facility cleaning St Marys",
                                "St Marys industrial cleaners"
                            ].map((keyword, index) => (
