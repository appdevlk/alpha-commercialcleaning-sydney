...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Campbelltown | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Campbelltown. We are the top-rated cleaning company for Medical Centre Cleaning in Campbelltown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Campbelltown",
                                "Healthcare cleaning services Campbelltown",
                                "Medical office cleaning Campbelltown",
                                "Dental clinic cleaning Campbelltown",
                                "Hospital grade cleaning Campbelltown",
                                "Clinical cleaning services Campbelltown",
                                "Medical facility cleaning Campbelltown",
                                "Doctor surgery cleaning Campbelltown",
                                "Professional medical cleaners Campbelltown",
                                "Sanitisation services Campbelltown",
                                "Medical cleaning company Campbelltown",
                                "Allied health cleaning Campbelltown",
                                "Pathology cleaning Campbelltown",
                                "Radiology cleaning services Campbelltown",
                                "Aged care cleaning Campbelltown",
                                "Infection control cleaning Campbelltown",
                                "Medical centre janitors Campbelltown",
                                "Commercial medical cleaning Campbelltown",
                                "Campbelltown medical cleaners",
                                "Sterile cleaning services Campbelltown"
                            ].map((keyword, index) => (
