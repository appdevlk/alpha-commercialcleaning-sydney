...
export const metadata: Metadata = {
    title: "Warehouse Cleaning Bankstown | Professional Cleaning Services",
    description: "Expert Warehouse Cleaning in Bankstown. We are the top-rated cleaning company for Warehouse Cleaning in Bankstown and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Warehouse cleaning services Bankstown",
                                "Industrial cleaning Bankstown",
                                "Factory cleaning Bankstown",
                                "Warehouse cleaners Bankstown",
                                "Distribution centre cleaning Bankstown",
                                "Warehouse floor cleaning Bankstown",
                                "Industrial sweep and scrub Bankstown",
                                "High pressure cleaning Bankstown",
                                "Workshop cleaning Bankstown",
                                "Manufacturing plant cleaning Bankstown",
                                "Warehouse dusting Bankstown",
                                "Bond warehouse cleaning Bankstown",
                                "End of lease warehouse cleaning Bankstown",
                                "Commercial warehouse cleaning Bankstown",
                                "Heavy duty cleaning Bankstown",
                                "Industrial degreasing Bankstown",
                                "Warehouse sanitisation Bankstown",
                                "Professional warehouse cleaners Bankstown",
                                "Storage facility cleaning Bankstown",
                                "Bankstown industrial cleaners"
                            ].map((keyword, index) => (
