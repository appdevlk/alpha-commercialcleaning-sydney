...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Randwick | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Randwick. We are the top-rated cleaning company for Medical Centre Cleaning in Randwick and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Randwick",
                                "Healthcare cleaning services Randwick",
                                "Medical office cleaning Randwick",
                                "Dental clinic cleaning Randwick",
                                "Hospital grade cleaning Randwick",
                                "Clinical cleaning services Randwick",
                                "Medical facility cleaning Randwick",
                                "Doctor surgery cleaning Randwick",
                                "Professional medical cleaners Randwick",
                                "Sanitisation services Randwick",
                                "Medical cleaning company Randwick",
                                "Allied health cleaning Randwick",
                                "Pathology cleaning Randwick",
                                "Radiology cleaning services Randwick",
                                "Aged care cleaning Randwick",
                                "Infection control cleaning Randwick",
                                "Medical centre janitors Randwick",
                                "Commercial medical cleaning Randwick",
                                "Randwick medical cleaners",
                                "Sterile cleaning services Randwick"
                            ].map((keyword, index) => (
