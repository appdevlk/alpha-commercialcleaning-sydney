...
export const metadata: Metadata = {
    title: "Strata Cleaning Auburn | Professional Cleaning Services",
    description: "Expert Strata Cleaning in Auburn. We are the top-rated cleaning company for Strata Cleaning in Auburn and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Strata cleaning services Auburn",
                                "Strata cleaners Auburn",
                                "Body corporate cleaning Auburn",
                                "Building management cleaning Auburn",
                                "Apartment complex cleaning Auburn",
                                "Residential building cleaning Auburn",
                                "Common area cleaning Auburn",
                                "Strata maintenance Auburn",
                                "Condominium cleaning Auburn",
                                "High rise cleaning Auburn",
                                "Stairwell cleaning Auburn",
                                "Car park cleaning Auburn",
                                "Garbage management Auburn",
                                "Strata gardening and cleaning Auburn",
                                "Professional strata cleaners Auburn",
                                "Reliable strata cleaning Auburn",
                                "Strata cleaning rates Auburn",
                                "Sydney strata cleaning Auburn",
                                "Auburn strata services",
                                "Residential strata cleaning Auburn"
                            ].map((keyword, index) => (
