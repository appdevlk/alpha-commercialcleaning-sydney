...
export const metadata: Metadata = {
    title: "Gym Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Gym Cleaning in Brookvale. We are the top-rated cleaning company for Gym Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Gym cleaning services Brookvale",
                                "Fitness centre cleaning Brookvale",
                                "Gym cleaners Brookvale",
                                "Yoga studio cleaning Brookvale",
                                "CrossFit gym cleaning Brookvale",
                                "Sports centre cleaning Brookvale",
                                "Gym equipment cleaning Brookvale",
                                "Health club cleaning Brookvale",
                                "Commercial gym cleaning Brookvale",
                                "Professional gym cleaners Brookvale",
                                "Gym sanitisation Brookvale",
                                "Fitness facility cleaning Brookvale",
                                "24/7 gym cleaning Brookvale",
                                "Local gym cleaners Brookvale",
                                "Best gym cleaning company Brookvale",
                                "Martial arts studio cleaning Brookvale",
                                "Pilates studio cleaning Brookvale",
                                "Gym floor cleaning Brookvale",
                                "Gym hygiene services Brookvale",
                                "Brookvale fitness cleaners"
                            ].map((keyword, index) => (
