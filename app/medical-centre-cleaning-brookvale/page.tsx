...
export const metadata: Metadata = {
    title: "Medical Centre Cleaning Brookvale | Professional Cleaning Services",
    description: "Expert Medical Centre Cleaning in Brookvale. We are the top-rated cleaning company for Medical Centre Cleaning in Brookvale and surrounding Western Sydney. Call 02 9140 6024 for a quote.",
};
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                "Medical centre cleaning Brookvale",
                                "Healthcare cleaning services Brookvale",
                                "Medical office cleaning Brookvale",
                                "Dental clinic cleaning Brookvale",
                                "Hospital grade cleaning Brookvale",
                                "Clinical cleaning services Brookvale",
                                "Medical facility cleaning Brookvale",
                                "Doctor surgery cleaning Brookvale",
                                "Professional medical cleaners Brookvale",
                                "Sanitisation services Brookvale",
                                "Medical cleaning company Brookvale",
                                "Allied health cleaning Brookvale",
                                "Pathology cleaning Brookvale",
                                "Radiology cleaning services Brookvale",
                                "Aged care cleaning Brookvale",
                                "Infection control cleaning Brookvale",
                                "Medical centre janitors Brookvale",
                                "Commercial medical cleaning Brookvale",
                                "Brookvale medical cleaners",
                                "Sterile cleaning services Brookvale"
                            ].map((keyword, index) => (
